...
setTexST:function(a,b){this._texST=vec2.fromValues(a,b)},getTexS:function(){return this._texST[0]},getTexT:function(){return this._texST[1]},getNormal:function(){if(void 0===this._normal)throw Error("Vertex surface normal has not been defined.");return vec3.clone(this._normal)},setNormal:function(a,b,c){this._normal=vec3.fromValues(a,b,c);this._normal=vec3.normalize(this._normal,this._normal)},getTangental:function(){if(void 0===this._tangental)throw Error("Vertex surface tangental has not been defined.");
return vec3.clone(this._tangental)},computeTangental:function(a,b){var c=vec3.fromValues(a.getX()-this.getX(),a.getY()-this.getY(),a.getZ()-this.getZ()),d=vec3.fromValues(b.getX()-this.getX(),b.getY()-this.getY(),b.getZ()-this.getZ()),e=a.getTexS()-this.getTexS(),f=b.getTexS()-this.getTexS(),g=a.getTexT()-this.getTexT(),h=b.getTexT()-this.getTexT(),e=h*e-g*f;if(0==e)return vec3.fromValues(1,0,0);f=vec3.create();vec3.scale(f,c,h);vec3.sub(f,f,vec3.scale(vec3.create(),d,g));vec3.scale(f,f,1/e);return f},
setTangental:function(a){this._tangental=vec3.fromValues(a[0],a[1],a[2]);this._tangental=vec3.normalize(this._tangental,this._tangental)},clone:function(){return this.transform(mat4.create())},transform:function(a){var b=vec4.transformMat4(vec4.create(),this.getXYZ(),a),b=new TentaGL.Vertex(b[0],b[1],b[2]);if(void 0!==this._normal){var c=this.getNormal(),c=vec4.fromValues(c[0],c[1],c[2],0),c=vec4.transformMat4(c,c,a);b.setNormal(c[0],c[1],c[2])}void 0!==this._tangental&&(c=this.getTangental(),c=vec4.fromValues(c[0],
c[1],c[2],0),c=vec4.transformMat4(c,c,a),b.setTangental(c[0],c[1],c[2]));void 0!==this._texST&&b.setTexST(this.getTexS(),this.getTexT());return b}};TentaGL.ImageLoader={_numLoading:0,load:function(a,b,c){var d=this;this._numLoading++;c||(c=function(){throw Error("Could not load image at "+a+".");});var e=new Image;e.onload=function(){b(e);d._numLoading--};e.src=a},isLoading:function(){return 0<this._numLoading}};TentaGL.PixelData=function(a,b,c){this._pixels=a;this._width=b;this._height=c};
...
TentaGL.RGBAFilter.OutlineColor.prototype={constructor:TentaGL.RGBAFilter.OutlineColor,getColor:function(){return this._color},filter:function(a,b,c,d,e){var f=b[c],g=b[c+1],h=b[c+2],l=b[c+3];if(255!=l)for(var k=TentaGL.PixelData.indexToXY(c,d),m=k[0],k=k[1],q=-1;1>=q;q++){var r=k+q;if(!(r>=e||0>r))for(var n=-1;1>=n;n++){var s=m+n;if(!(s>=d||0>s)&&(s=TentaGL.PixelData.xyToIndex(s,r,d),255==b[s+3]))return f=this._color.getRedByte(),g=this._color.getGreenByte(),h=this._color.getBlueByte(),this.setPixel(a,
...
0))}};TentaGL.Material=function(){};TentaGL.Material.prototype={isaMaterial:!0,clean:function(a){},useMe:function(a){},isLoaded:function(){}};
...
TentaGL.VBOData=function(a,b,c){var d=[];this._byteOffsets={};for(var e=b.getVertices(),f=0;f<e.length;f++){var g=e[f],h=0,l;for(l in c){var k=c[l],m=k.getValues(g);this._byteOffsets[l]=h;h+=k.sizeBytes();for(k=0;k<m.length;k++)d.push(m[k])}}this._attrBuffer=a.createBuffer();a.bindBuffer(GL_ARRAY_BUFFER,this._attrBuffer);a.bufferData(GL_ARRAY_BUFFER,new Float32Array(d),GL_STATIC_DRAW);d=b.getIndices();this._numIndices=b.numIndices();this._elemBuffer=a.createBuffer();a.bindBuffer(GL_ELEMENT_ARRAY_BUFFER,
...
removePickEventListener:function(a){a=this._pickEventListeners.indexOf(node);if(-1==a)return!1;this._pickEventListeners.splice(a,1);return!0},getTRSTransform:function(){var a=this.getX(),b=this.getY(),c=this.getZ(),d=0-this.getAnchorX(),e=0-this.getAnchorY(),f=0-this.getAnchorZ(),g=this.getScaleUni(),h=this.getScaleX()*g,l=this.getScaleY()*g,g=this.getScaleZ()*g,k=this._transform;mat4.fromQuat(k,this.getQuat());k[0]*=h;k[1]*=h;k[2]*=h;k[4]*=l;k[5]*=l;k[6]*=l;k[8]*=g;k[9]*=g;k[10]*=g;k[12]=d*k[0]+
e*k[4]+f*k[8]+a;k[13]=d*k[1]+e*k[5]+f*k[9]+b;k[14]=d*k[2]+e*k[6]+f*k[10]+c;k[15]=1;return k},draw:function(a){}};Util.Inheritance.inherit(TentaGL.Sprite,TentaGL.SceneNode);TentaGL.BillboardSprite=function(a){TentaGL.Sprite.call(this,a)};
...
TentaGL.BlitteredFont.fromFont=function(a,b,c,d,e){var f="monospace"==a.getType(),g=a.getStringDimensions("W"),h=g[0],g=g[1];c=new TentaGL.BlitteredFont(void 0,f,h,g,c,d);d=1.5<b.getRed()+b.getGreen()+b.getBlue()?new TentaGL.Color.RGBA(0,0,0,1):new TentaGL.Color.RGBA(1,1,1,1);for(var l=TentaGL.Canvas2D.create(16*(h+2),6*(g+2),d),k=32;128>k;k++){var m=1+(k-32)%16*(h+2),q=1+Math.floor((k-32)/16)*(g+2),r=String.fromCharCode(k),n=TentaGL.Canvas2D.create(h,g,d);TentaGL.Canvas2D.drawString(n,r,a,b,0,0);
TentaGL.Canvas2D.drawImage(l,n,m,q)}a=TentaGL.PixelData.fromCanvas(l);a=a.filter(new TentaGL.RGBAFilter.OneColor(b,.5));e&&(a=e(a));c._createChars(a,f,h,g);return c};TentaGL.Font=function(a,b,c){this._name=a;this._type=b;this._size=c;this._italic=this._bold=!1;this._vPad=1};
