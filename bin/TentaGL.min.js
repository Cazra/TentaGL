...
a},useMe:function(a){var b=TentaGL.ShaderLib.current(a);b.setMaterialProps&&b.setMaterialProps(a,this)}};TentaGL.RenderMode={};TentaGL.RenderMode.set3DOpaque=function(a){TentaGL.Blend.setEnabled(a,!1);TentaGL.DepthBuffer.setEnabled(a,!0);TentaGL.DepthBuffer.setMaskEnabled(a,!0);TentaGL.Cull.setMode(a,GL_NONE)};
...
TentaGL.SceneNode=function(a){void 0===a&&(a=[0,0,0]);a[2]||(a[2]=0);this._xyz=vec4.fromValues(a[0],a[1],a[2],1);this._scaleXYZ=[1,1,1];this._scaleUni=1;this._quat=quat.create();this._objLook=vec3.fromValues(0,0,1);this._objUp=vec3.fromValues(0,1,0);this._transform=mat4.create();this._isVisible=this._tranDirty=!0;this._opacity=1;this._parent=void 0};
...
b=b.getCompositeParent();return a},isVisible:function(){return this._isVisible},setVisible:function(a){this._isVisible=a},opacity:function(a){a&&(this._opacity=Math.max(0,Math.min(a,1)));return this._opacity},useOpacity:function(a){var b=TentaGL.ShaderLib.current(a);b.setOpacity&&b.setOpacity(a,this._opacity)},getXYZ:function(){return this._xyz},getWorldXYZ:function(){var a=this.getWorldTransform();return vec4.fromValues(a[12],a[13],a[14],1)},setXYZ:function(a){this._xyz[0]=a[0];this._xyz[1]=a[1];
this._xyz[2]=a[2];this._tranDirty=!0},getX:function(){return this._xyz[0]},getY:function(){return this._xyz[1]},getZ:function(){return this._xyz[2]},xyz:function(a){if(a)this.setXYZ(a);else return this.getXYZ()},x:function(a){if(a)this._xyz[0]=a,this._tranDirty=!0;else return this._xyz[0]},y:function(a){if(a)this._xyz[1]=a,this._tranDirty=!0;else return this._xyz[1]},z:function(a){if(a)this._xyz[2]=a,this._tranDirty=!0;else return this._xyz[2]},getQuat:function(){return this._quat},getWorldQuat:function(){return this._getWorldQuat(quat.create())},
_getWorldQuat:function(a){quat.mul(a,this.getQuat(),a);return this._parent?this._parent._getWorldQuat(a):a},setQuat:function(a){this._quat=a;this._tranDirty=!0},getParentWorldQuat:function(){return this._parent?this._parent.getWorldQuat():quat.create()},rotate:function(a,b){var c=quat.setAxisAngle(quat.create(),a,b);this.setQuat(quat.mul(this._quat,c,this._quat))},mulQuat:function(a){this.setQuat(quat.mul(this._quat,a,this._quat))},getBaseLook:function(){return this._objLook},getWorldBaseLook:function(){var a=
this.getParentWorldQuat();return vec3.transformQuat(vec3.create(),this._objLook,a)},setBaseLook:function(a){vec3.normalize(this._objLook,a);this._correctUpVector()},getLook:function(){return vec3.transformQuat(vec3.create(),this._objLook,this._quat)},getWorldLook:function(){var a=this.getWorldQuat();return vec3.transformQuat(vec3.create(),this.getBaseLook(),a)},getBaseRight:function(){return vec3.cross(vec3.create(),this._objLook,this._objUp)},getWorldBaseRight:function(){var a=this.getParentWorldQuat();
return vec3.transformQuat(vec3.create(),this.getBaseRight(),a)},getRight:function(){return vec3.transformQuat(vec3.create(),this.getBaseRight(),this._quat)},getWorldRight:function(){var a=this.getWorldQuat();return vec3.transformQuat(vec3.create(),this.getBaseRight(),a)},getUp:function(){return vec3.transformQuat(vec3.create(),this._objUp,this._quat)},getWorldUp:function(){var a=this.getWorldQuat();return vec3.transformQuat(vec3.create(),this.getBaseUp(),a)},getBaseUp:function(){return this._objUp},
getWorldBaseUp:function(){var a=this.getParentWorldQuat();return vec3.transformQuat(vec3.create(),this._objUp,a)},setBaseUp:function(a){vec3.normalize(this._objUp,a);this._correctUpVector()},_correctUpVector:function(){var a=this._objLook,b=this._objUp,c=vec3.cross(vec3.create(),a,b);this._objUp=vec3.cross(b,c,a)},getBaseLookVectors:function(){return[this.getBaseLook(),this.getBaseUp(),this.getBaseRight()]},getLookVectors:function(){this.getQuat();var a=vec3.transformQuat(vec3.create(),this._objLook,
this._quat),b=vec3.transformQuat(vec3.create(),this._objUp,this._quat),c=vec3.transformQuat(vec3.create(),this.getBaseRight,this._quat);return[a,b,c]},getWorldLookVectors:function(){this.getWorldQuat();var a=vec3.transformQuat(vec3.create(),this._objLook,this._quat),b=vec3.transformQuat(vec3.create(),this._objUp,this._quat),c=vec3.transformQuat(vec3.create(),this.getBaseRight,this._quat);return[a,b,c]},orient:function(a,b){this.setQuat(TentaGL.Math.getOrientation(this.getBaseLook(),this.getBaseUp(),
a,b))},orientWorld:function(a,b){var c=this.getParentWorldQuat();quat.invert(c,c);a=vec3.transformQuat(vec3.create(),a,c);b=vec3.transformQuat(vec3.create(),b,c);this.setQuat(TentaGL.Math.getOrientation(this.getBaseLook(),this.getBaseUp(),a,b))},lookAt:function(a){var b=this.getXYZ();a=vec3.fromValues(a[0]-b[0],a[1]-b[1],a[2]-b[2]);b=vec3.cross(vec3.create(),a,this.getBaseUp());b=vec3.cross(vec3.create(),b,a);this.orient(a,b)},lookAtWorld:function(a){var b=this.getWorldXYZ();a=vec3.fromValues(a[0]-
...
setScaleXYZ:function(a){this._scaleXYZ=vec3.fromValues(a[0],a[1],a[2]);this._tranDirty=!0},getScaleX:function(){return this._scaleXYZ[0]},getScaleY:function(){return this._scaleXYZ[1]},getScaleZ:function(){return this._scaleXYZ[2]},getScaleUni:function(){return this._scaleUni},setScaleUni:function(a){this._scaleUni=a;this._tranDirty=!0},getWorldScaleUni:function(){var a=this.getScaleUni();this._parent&&(a+=this._parent.getWorldScaleUni());return a},scale:function(a){if(a)this.setScaleXYZ(a);else return this.getScaleXYZ()},
scaleX:function(a){if(a)this._scaleXYZ[0]=a,this._tranDirty=!0;else return this._scaleXYZ[0]},scaleY:function(a){if(a)this._scaleXYZ[1]=a,this._tranDirty=!0;else return this._scaleXYZ[1]},scaleZ:function(a){if(a)this._scaleXYZ[2]=a,this._tranDirty=!0;else return this._scaleXYZ[2]},scaleU:function(a){if(a)this._scaleUni=a,this._tranDirty=!0;else return this._scaleUni},getModelTransform:function(){this._tranDirty&&(this._transform=this.getTRSTransform(),this._tranDirty=!1);return this._transform},getTRSTransform:function(){var a=
...
Util.Inheritance.inherit(TentaGL.SimpleShader,TentaGL.ShaderProgram);TentaGL.Timer=function(a){this._startTime=a;this._accumulated=0;this._countdown=void 0;this._state=void 0!==a?TentaGL.Timer.RUNNING:TentaGL.Timer.STOPPED};TentaGL.Timer.STOPPED=1;TentaGL.Timer.RUNNING=2;TentaGL.Timer.PAUSED=3;
