...
var TentaGL={versionMajor:0,versionMinor:19,createGL:function(a,b){b=b||{alpha:!1};try{var c=a.getContext("webgl",b)||a.getContext("experimental-webgl",b)||a.getContext("webkit-3d",b)||a.getContext("moz-webgl",b);TentaGL.Blend.reset(c);TentaGL.Cull.reset(c);TentaGL.DepthBuffer.reset(c);TentaGL.Scissor.reset(c);TentaGL.Stencil.reset(c);TentaGL.Viewport.reset(c);TentaGL.ViewTrans.reset(c);this._normalTrans=mat3.create();this._mvpTrans=mat4.create();return c}catch(d){throw Error("Error creating WebGL context: "+
...
TentaGL.Stencil={enabled:function(a,b){void 0!==b&&b!=a._stencilEnabled&&((a._stencilEnabled=b)?a.enable(GL_STENCIL_TEST):a.disable(GL_STENCIL_TEST));return a._stencilEnabled},clearValue:function(a,b){void 0!==b&&b!=a._stencilClearVal&&(a._stencilClearVal=b,a.clearStencil(b));return a._stencilClearVal},func:function(a,b,c,d){void 0!==b&&(a._stencilFunc=b,a._stencilRef=c,a._stencilMask=d,a.stencilFunc(b,c,d));return a._stencilFunc},getRef:function(a){return a._stencilRef},mask:function(a,b){void 0!==
b&&(a._stencilWriteMask=b,a.stencilMask(b));return a._stencilWriteMask},op:function(a,b,c,d){void 0!==b&&(a._stencilFailS=b,a._stencilFailDP=c,a._stencilPassDP=d,a.stencilOp(b,c,d));return[a._stencilFailS,a._stencilFailDP,a._stencilPassDP]},createStencilBuffer:function(a,b,c){var d=a.createRenderbuffer();a.bindRenderbuffer(a.RENDERBUFFER,d);a.renderbufferStorage(a.RENDERBUFFER,a.STENCIL_INDEX8,b,c);a.bindRenderbuffer(a.RENDERBUFFER,null);return d},reset:function(a){a._stencilEnabled=!1;a._stencilClearVal=
0;a._stencilFunc=GL_ALWAYS;a._stencilRef=0;a._stencilMask=255;a._stencilWriteMask=255;a._stencilFailS=GL_KEEP;a._stencilFailDP=GL_KEEP;a._stencilPassDP=GL_KEEP;a._stencilStack=[]},push:function(a){a._stencilStack.push({_stencilEnabled:a._stencilEnabled,_stencilClearVal:a._stencilClearVal,_stencilFunc:a._stencilFunc,_stencilRef:a._stencilRef,_stencilMask:a._stencilMask,_stencilWriteMask:a._stencilWriteMask,_stencilFailS:a._stencilFailS,_stencilFailDP:a._stencilFailDP,_stencilPassDP:a._stencilPassDP})},
pop:function(a){var b=a._stencilStack.pop();this.enabled(a,b._stencilEnabled);this.clearValue(a,b._stencilClearVal);this.func(a,b._stencilFunc,b._stencilRef,b._stencilMask);this.mask(a,b._stencilWriteMask);this.op(a,b._stencilFailS,b._stencilFailDP,b._stencilPassDP)}};
