...
a[1];this._xyz[2]=a[2];this._tranDirty=!0},getX:function(){return this._xyz[0]},getY:function(){return this._xyz[1]},getZ:function(){return this._xyz[2]},xyz:function(a){if(a)this.setXYZ(a);else return this.getXYZ()},x:function(a){if(a)this._xyz[0]=a,this._tranDirty=!0;else return this._xyz[0]},y:function(a){if(a)this._xyz[1]=a,this._tranDirty=!0;else return this._xyz[1]},z:function(a){if(a)this._xyz[2]=a,this._tranDirty=!0;else return this._xyz[2]},getQuat:function(){return this._quat},getWorldQuat:function(){return this._getWorldQuat(quat.create())},
