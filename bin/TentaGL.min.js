...
TentaGL.UI.Tooltip=function(a,b,c,d,e){this._bgMatName=b;this._blitFont=a;void 0===e&&(e=a.getLineHeight());this._charHeight=e;this.xy([0,0]);this.text("");this.padding(c);this.delay(d)};
...
delay:function(a){void 0!==a&&(this._delay=a);return this._delay},render:function(a){if(void 0!==this._component){TentaGL.ViewTrans.push(a);TentaGL.ViewTrans.translate(a,this._xy);var b=this.getDimensions();TentaGL.MaterialLib.use(a,this._bgMatName);TentaGL.ViewTrans.push(a);TentaGL.ViewTrans.scale(a,b);TentaGL.ModelLib.render(a,"unitSprite");TentaGL.ViewTrans.pop(a);this._blitFont.renderString(a,this._text,[this._pad,this._pad],!0,this._charHeight);TentaGL.ViewTrans.pop(a)}}};
