...
0))}};TentaGL.Light=function(a,b,c){a||(a=TentaGL.Color.RGBA(1,1,1,1));b||(b=TentaGL.Color.RGBA(1,1,1,1));c||(c=TentaGL.Color.RGBA(0,0,0,1));this._diffuse=a;this._specular=b;this._ambient=c};
...
TentaGL.MaterialProps=function(a,b,c,d,e){a||(a=TentaGL.Color.RGBA(1,1,1,1));b||(b=TentaGL.Color.RGBA(1,1,1,1));c||(c=0);d||(d=TentaGL.Color.RGBA(1,1,1,1));e||(e=TentaGL.Color.RGBA(0,0,0,1));this._diffuse=a;this._specular=b;this._shininess=c;this._ambient=d;this._emission=e};
...
this._mvpUni=this.getUniform("mvpTrans");this._mvUni=this.getUniform("mvTrans");this._vUni=this.getUniform("vTrans");this._normalUni=this.getUniform("normalTrans");this._texUni=this.getUniform("tex");this._bumpTexUni=this.getUniform("bumpTex");this._useBumpUni=this.getUniform("useBumpTex");this._materialUni={};this._materialUni.diff=this.getUniform("m.diff");this._materialUni.spec=this.getUniform("m.spec");this._materialUni.amb=this.getUniform("m.amb");this._materialUni.emis=this.getUniform("m.emis");
this._materialUni.shininess=this.getUniform("m.shininess");this._lightsUni=[];for(a=0;a<TentaGL.PhongShader.MAX_LIGHTS;a++){var b=this._lightsUni[a]={},c="lights["+a+"]";b.type=this.getUniform(c+".type");b.pos=this.getUniform(c+".pos");b.dir=this.getUniform(c+".dir");b.diff=this.getUniform(c+".diff");b.spec=this.getUniform(c+".spec");b.amb=this.getUniform(c+".amb");b.attenA=this.getUniform(c+".attenA");b.attenB=this.getUniform(c+".attenB");b.attenC=this.getUniform(c+".attenC");b.cutOffAngle=this.getUniform(c+
".cutOffAngle");b.spotExp=this.getUniform(c+".spotExp")}this._numLightsUni=this.getUniform("numLights")};TentaGL.PhongShader.MAX_LIGHTS=16;TentaGL.PhongShader.LIGHT_AMB=1;TentaGL.PhongShader.LIGHT_PT=2;TentaGL.PhongShader.LIGHT_DIR=3;TentaGL.PhongShader.LIGHT_SPOT=4;
TentaGL.PhongShader.prototype={constructor:TentaGL.PhongShader,isaPhongShader:!0,setMVPTrans:function(a,b){this._mvpUni.set(a,b)},setMVTrans:function(a,b){this._mvUni.set(a,b)},setVTrans:function(a,b){this._vUni.set(a,b)},setNormalTrans:function(a,b){this._normalUni.set(a,b)},setTex:function(a,b){this._texUni.set(a,[b]);this._useBumpUni.set(a,[0])},setBump:function(a,b){this._bumpTexUni.set(a,[b]);this._useBumpUni.set(a,[1])},setMaterialProps:function(a,b){this._materialUni.diff.set(a,b.getDiffuse().getRGBA());
this._materialUni.spec.set(a,b.getSpecular().getRGBA());this._materialUni.amb.set(a,b.getAmbient().getRGBA());this._materialUni.emis.set(a,b.getEmission().getRGBA());this._materialUni.shininess.set(a,[b.getShininess()])},setLights:function(a,b){var c=Math.min(b.length,TentaGL.PhongShader.MAX_LIGHTS);this._numLightsUni.set(a,[b.length]);for(var d=0;d<c;d++){var e=b[d],f=this._lightsUni[d];e.isaAmbientLight&&f.type.set(a,[TentaGL.PhongShader.LIGHT_AMB]);e.isaPointLight&&f.type.set(a,[TentaGL.PhongShader.LIGHT_PT]);
e.isaDirectionalLight&&f.type.set(a,[TentaGL.PhongShader.LIGHT_DIR]);e.isaSpotLight&&f.type.set(a,[TentaGL.PhongShader.LIGHT_SPOT]);e.isaPointLight?f.pos.set(a,e.getXYZ()):f.pos.set(a,[0,0,0,0]);e.isaDirectionalLight?f.dir.set(a,e.getDirection()):f.dir.set(a,[0,0,0]);f.diff.set(a,e.getDiffuse().getRGBA());f.spec.set(a,e.getSpecular().getRGBA());f.amb.set(a,e.getAmbient().getRGBA());if(e.isaPointLight){var g=e.getAttenuation();f.attenA.set(a,[g[0]]);f.attenB.set(a,[g[1]]);f.attenC.set(a,[g[2]])}else f.attenA.set(a,
[0]),f.attenB.set(a,[0]),f.attenC.set(a,[0]);e.isaSpotLight?(f.cutOffAngle.set(a,[e.getCutOffAngle()]),f.spotExp.set(a,[e.getSpotExponent()])):(f.cutOffAngle.set(a,[0]),f.spotExp.set(a,[0]))}for(d=c;d<TentaGL.PhongShader.MAX_LIGHTS;d++)f=this._lightsUni[d],f.type.set(a,[0]),f.pos.set(a,[0,0,0,0]),f.dir.set(a,[0,0,0]),f.diff.set(a,[0,0,0,0]),f.spec.set(a,[0,0,0,0]),f.amb.set(a,[0,0,0,0]),f.attenA.set(a,[0]),f.attenB.set(a,[0]),f.attenC.set(a,[0]),f.cutOffAngle.set(a,[0]),f.spotExp.set(a,[0])}};
TentaGL.PhongShader.load=function(a,b){var c=new TentaGL.PhongShader(a);TentaGL.ShaderLib.add(a,b,c);return c};Util.Inheritance.inherit(TentaGL.PhongShader,TentaGL.ShaderProgram);
