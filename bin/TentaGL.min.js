...
c.click()}};Util||(Util={});Util.Inheritance={inherit:function(a,b){for(var c in b.prototype)a.prototype[c]||(a.prototype[c]=b.prototype[c])}};
...
p=parseInt(k[3])-1,5==k.length?(n=parseInt(k[4])-1,e.addFaceQuad(g,l,p,n)):e.addFace(g,l,p);else if("usemtl"!=k[0])throw Error("Could not read wavefront object. Error at line "+(m+1));f++;g=k[0]}}c[d]=e;b(c)},isLoading:function(){return 0<this._numLoading},getNumLoading:function(){return this._numLoading}};TentaGL.Vertex=function(a,b,c){this._xyz=vec4.fromValues(a,b,c,1);this._texST=vec2.fromValues(0,0);this._normal=vec3.fromValues(0,0,0);this._tangental=vec3.fromValues(0,0,0)};
...
Util.Inheritance.inherit(TentaGL.BillboardSprite,TentaGL.Sprite);TentaGL.ButtonSprite=function(a){TentaGL.Sprite.call(this,a);this.resetMouseState();this.setEnabled(!0)};
