...
TentaGL.AudioLoader={_numLoading:0,load:function(a,b,c){var d=this;this._numLoading++;c||(c=function(){d._numLoading--;throw Error("Could not load image at "+a+".");});var e=new Audio;e.oncanplaythrough=function(){b(e);d._numLoading--};e.src=a;e.load()},isLoading:function(){return 0<this._numLoading}};TentaGL.Camera=function(){};
...
0))},getCanvasWidth:function(){return canvas.width},getCanvasHeight:function(){return canvas.height}};TentaGL.Light=function(a,b,c){a||(a=TentaGL.Color.RGBA(1,1,1,1));b||(b=TentaGL.Color.RGBA(1,1,1,1));c||(c=TentaGL.Color.RGBA(0,0,0,1));this._diffuse=a;this._specular=b;this._ambient=c};
