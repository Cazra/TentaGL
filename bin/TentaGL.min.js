...
func:function(a,b){void 0!==b&&this.setFunc(a,b);return a._depthFunc},setMaskEnabled:function(a,b){a._depthWrite!=b&&(a._depthWrite=b,a.depthMask(b))},isMaskEnabled:function(a){return a._depthWrite},mask:function(a,b){void 0!==b&&this.setMaskEnabled(a,b);return a._depthWrite},setRange:function(a,b,c){b=TentaGL.Math.clamp(b,0,1);c=TentaGL.Math.clamp(c,0,1);if(a._depthWinNear!=b||a._depthWinFar!=c)a._depthWinNear=b,a._depthWinFar=c,a.depthRange(b,c)},getRangeNear:function(a){return a._depthWinNear},
getRangeFar:function(a){return a._depthWinFar},setClearValue:function(a,b){b=TentaGL.Math.clamp(b,0,1);a._depthClearVal!=b&&(a._depthClearVal=b,a.clearDepth(b))},getClearValue:function(){return gl._depthClearVal},clearValue:function(a,b){void 0!==b&&this.setClearValue(a,b);return a._depthClearVal},clear:function(a){a.clear(GL_DEPTH_BUFFER_BIT)},createBuffer:function(a,b,c){var d=a.createRenderbuffer();a.bindRenderbuffer(GL_RENDERBUFFER,d);a.renderbufferStorage(GL_RENDERBUFFER,GL_DEPTH_COMPONENT16,
b,c);a.bindRenderbuffer(GL_RENDERBUFFER,null);return d}};
