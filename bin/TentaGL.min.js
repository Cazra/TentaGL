...
this._b,this._a),c=vec3.sub([],this._c,this._a),d=[],d=d.concat(b),d=d.concat(c);mat2.invert(d,d);vec2.transformMat2(a,a,d);a=a[0]+a[1];return 0<=a&&1>=a},getBoundingBox:function(){var a=Math.min(this._a[0],this._b[0],this._c[0]),b=Math.max(this._a[0],this._b[0],this._c[0])-a,c=Math.min(this._a[1],this._b[1],this._c[1]),d=Math.max(this._a[1],this._b[1],this._c[1])-c;return new TentaGL.Math.Rect2D([a,c],b,d)},render:function(a,b){var c=vec2.copy([],this._a);c[2]=0;var d=vec2.copy([],this._b);d[2]=
0;var e=vec2.copy([],this._c);e[2]=0;var f=vec2.sub([],this._b,this._a),g=vec2.sub([],this._c,this._a),f=vec2.cross([],f,g),g=new TentaGL.Model(GL_TRIANGLES,GL_NONE),c=new TentaGL.Vertex(c);c.normal(f);c.st([0,0]);g.addVertex(c);d=new TentaGL.Vertex(d);d.normal(f);d.st([1,0]);g.addVertex(d);e=new TentaGL.Vertex(e);e.normal(f);e.st([.5,1]);g.addVertex(e);g.addFace(0,1,2);g.render(a,b)}};Util.Inheritance.inherit(TentaGL.Math.Triangle2D,TentaGL.Math.Shape2D);TentaGL.Math.Shape3D=function(){};
TentaGL.Math.Shape3D.prototype={constructor:TentaGL.Math.Shape3D,isaShape3D:!0,containsPt:function(a,b){},getBoundingBox:function(){},render:function(a,b){}};Util.Inheritance.inherit(TentaGL.Math.Shape3D,TentaGL.Renderable);TentaGL.Math.Line3D=function(a,b){this._p1=vec3.clone(a);this._p1[3]=1;this._p2=vec3.clone(b);this._p2[3]=1;this._length=vec3.dist(a,b)};
...
this.getAnchorX(),e=0-this.getAnchorY(),f=0-this.getAnchorZ(),g=this.getScaleUni(),h=this.getScaleX()*g,l=this.getScaleY()*g,g=this.getScaleZ()*g,k=this._transform;mat4.fromQuat(k,this.getQuat());k[0]*=h;k[1]*=h;k[2]*=h;k[4]*=l;k[5]*=l;k[6]*=l;k[8]*=g;k[9]*=g;k[10]*=g;k[12]=d*k[0]+e*k[4]+f*k[8]+a;k[13]=d*k[1]+e*k[5]+f*k[9]+b;k[14]=d*k[2]+e*k[6]+f*k[10]+c;k[15]=1;return k},draw:function(a){}};Util.Inheritance.inherit(TentaGL.Sprite,TentaGL.SceneNode);
...
!0;else{if(this._isRightPressed)this.onRightClick(b);this._isRightPressed=!1}}this._tooltipPosition=b.getXY();vec2.add(this._tooltipPosition,this._tooltipPosition,[0,16])}else{if(0<=this._mouseOverStart)this.onMouseExit(b);this.resetMouseState()}},isPressed:function(){return this._isLeftPressed},timeMouseOvered:function(){return-1==this._mouseOverStart?-1:Date.now()-this._mouseOverStart},isMouseOvered:function(){return 0<=this._mouseOverStart},isEnabled:function(){return this._enabled},setEnabled:function(a){this._enabled=
a},setTooltip:function(a,b){this._tooltip=b;this._tooltipText=a},draw:function(a){this._tooltipText&&(this._tooltip||(this._tooltip=TentaGL.Tooltip.getDefault(a)),this.timeMouseOvered()>=this._tooltip.delay()&&this._tooltip.render(a,this._tooltipText,this._tooltipPosition))},onClick:function(a){},onRightClick:function(a){},onMouseOver:function(a){},onMouseExit:function(a){}};Util.Inheritance.inherit(TentaGL.ButtonSprite,TentaGL.Sprite);
...
TentaGL.Tooltip.prototype={constructor:TentaGL.Tooltip,isaTooltip:!0,text:function(a){this._text=a;this._dims=this._blitFont.getStringDimensions("")},getDimensions:function(){return[this._dims[0]+2*this._pad,this._dims[1]+2*this._pad]},padding:function(a){void 0!==a&&(this._pad=a);return this._pad},delay:function(a){void 0!==a&&(this._delay=a);return this._delay},render:function(a,b,c){b&&this.text(b);c&&TentaGL.ViewTrans.translate(a,c);b=this.getDimensions();TentaGL.MaterialLib.use(a,this._bgMatName);
TentaGL.ViewTrans.push(a);TentaGL.ViewTrans.scale(a,b);TentaGL.ModelLib.render(a,"unitSprite");TentaGL.ViewTrans.pop(a);this._blitFont.renderString(a,this._text,[this._pad,this._pad],!0)}};Util.Inheritance.inherit(TentaGL.Tooltip,TentaGL.Renderable);