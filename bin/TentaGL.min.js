...
TentaGL._glUnitTypes[GL_BOOL_VEC2]=GL_BOOL;TentaGL._glUnitTypes[GL_BOOL_VEC3]=GL_BOOL;TentaGL._glUnitTypes[GL_BOOL_VEC4]=GL_BOOL;TentaGL._glUnitTypes[GL_FLOAT_MAT2]=GL_FLOAT;TentaGL._glUnitTypes[GL_FLOAT_MAT3]=GL_FLOAT;TentaGL._glUnitTypes[GL_FLOAT_MAT4]=GL_FLOAT;var Util;Util||(Util={});Util.Debug={arrayString:function(a){for(var b="[",c=!0,d=0;d<a.length;d++)c?c=!1:b+=", ",b+=a[d];return b+"]"},objString:function(a){var b="{",c=!0,d;for(d in a)c?c=!1:b+=", ",b+=d+":"+a[d];return b+"}"}};
