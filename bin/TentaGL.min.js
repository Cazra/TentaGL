...
equation:function(a,b,c,d){void 0!==b&&this.setEquation(a,b,c,d);return a._blendEquation},getSrcFunc:function(a){return a._blendSrcFunc},getDstFunc:function(a){return a._blendDstFunc},color:function(a,b){if(void 0!==b){var c=b.getRed(),d=b.getGreen(),e=b.getBlue(),f=b.getAlpha();if(a._blendRed!=c||a._blendGreen!=d||a._blendBlue!=e||a._blendAlpha!=f)a._blendRed=c,a._blendGreen=d,a._blendBlue=e,a._blendAlpha=f,a.blendColor(c,d,e,f)}return TentaGL.Color.RGBA(a._blendRed,a._blendGreen,a._blendBlue,a._blendAlpha)},
reset:function(a){a._blendEnabled=!1;a._blendEquation=GL_FUNC_ADD;a._blendSrcFunc=GL_ONE;a._blendDstFunc=GL_ZERO;a._blendRed=0;a._blendGreen=0;a._blendBlue=0;a._blendAlpha=0}};
TentaGL.ColorBuffer={reset:function(a){a._cbRed=0;a._cbGreen=0;a._cbBlue=0;a._cbAlpha=0;a._cbWriteRed=!0;a._cbWriteGreen=!0;a._cbWriteBlue=!0;a._cbWriteAlpha=!0;a._stateStack=[]},setClearColor:function(a,b){TentaGL.Picker.isPicking(a)||(a._cbRed=b.getRed(),a._cbGreen=b.getGreen(),a._cbBlue=b.getBlue(),a._cbAlpha=b.getAlpha(),a.clearColor(a._cbRed,a._cbGreen,a._cbBlue,a._cbAlpha))},getClearColor:function(a){return vec4.fromValues(a._cbRed,a._cbGreen,a._cbBlue,a._cbAlpha)},setWriteable:function(a,b,
c,d,e){a._cbWriteRed=b;a._cbWriteGreen=c;a._cbWriteBlue=d;a._cbWriteAlpha=e;a.colorMask(b,c,d,e)},clear:function(a,b){b&&this.setClearColor(a,b);a.clear(GL_COLOR_BUFFER_BIT)},push:function(a){a._stateStack.push({red:a._cbRed,green:a._cbGreen,blue:a._cbBlue,alpha:a._cbAlpha,writeRed:a._cbWriteRed,writeGreen:a._cbWriteGreen,writeBlue:a._cbWriteBlue,writeAlpha:a._cbWriteAlpha})},pop:function(a){var b=a._stateStack.pop();a._cbRed=b.red;a._cbGreen=b.green;a._cbBlue=b.blue;a._cbAlpha=b.alpha;a._cbWriteRed=
b.writeRed;a._cbWriteGreen=b.writeGreen;a._cbWriteBlue=b.writeBlue;a._cbWriteAlpha=b.writeAlpha}};TentaGL.Cull={setMode:function(a,b){a._cullMode!=b&&(a._cullMode=b,b==GL_NONE?a.disable(GL_CULL_FACE):(a.enable(GL_CULL_FACE),a.cullFace(b)))},getMode:function(a){return a._cullMode},mode:function(a,b){void 0!==b&&this.setMode(a,b);return a._cullMode},reset:function(a){a._cullMode=GL_NONE}};
...
TentaGL.Scissor={reset:function(a){a._scissorX=0;a._scissorY=0;a._scissorWidth=1;a._scissorHeight=1;a._scissorEnabled=!1},enabled:function(a,b){void 0!==b&&a._scissorEnabled!=b&&((a._scissorEnabled=b)?a.enable(GL_SCISSOR_TEST):a.disable(GL_SCISSOR_TEST));return a._scissorEnabled},xywh:function(a,b){void 0!==b&&(a._scissorX=b[0],a._scissorY=b[1],a._scissorWidth=b[2],a._scissorHeight=b[3],a.scissor(b[0],b[1],b[2],b[3]));return[a._scissorX,a._scissorY,a._scissorWidth,a._scissorHeight]},push:function(a){a._scissorStack||
(a._scissorStack=[]);a._scissorStack.push(this.xywh(a))},pop:function(a){this.xywh(a,a._scissorStack.pop())}};
