...
c.getUniform("normalTrans");c._startPtUni=c.getUniform("p");c._gradVectorUni=c.getUniform("u");c._colorsUni=c.getUniform("colors[0]");c._breakPtsUni=c.getUniform("breakPts[0]");c._breakPtCountUni=c.getUniform("breakPtCount")})};
...
setMaterialProps:function(a,b){this._materialUni.diff.set(a,b.diffuse().getRGBA());this._materialUni.spec.set(a,b.specular().getRGBA());this._materialUni.amb.set(a,b.ambient().getRGBA());this._materialUni.emis.set(a,b.emission().getRGBA());this._materialUni.shininess.set(a,[b.shininess()])},setLights:function(a,b){var c=Math.min(b.length,TentaGL.LightsShader.MAX_LIGHTS);this._numLightsUni.set(a,[b.length]);for(var d=0;d<c;d++){var e=b[d],f=this._lightsUni[d];e.isaAmbientLight&&f.type.set(a,[TentaGL.LightsShader.LIGHT_AMB]);
e.isaPointLight&&f.type.set(a,[TentaGL.LightsShader.LIGHT_PT]);e.isaDirectionalLight&&f.type.set(a,[TentaGL.LightsShader.LIGHT_DIR]);e.isaSpotLight&&f.type.set(a,[TentaGL.LightsShader.LIGHT_SPOT]);e.isaPointLight?f.pos.set(a,e.xyz()):f.pos.set(a,[0,0,0,0]);e.isaDirectionalLight?f.dir.set(a,e.direction()):f.dir.set(a,[0,0,0]);f.diff.set(a,e.diffuse().getRGBA());f.spec.set(a,e.specular().getRGBA());f.amb.set(a,e.ambient().getRGBA());if(e.isaPointLight){var g=e.attenuation();f.attenA.set(a,[g[0]]);f.attenB.set(a,
[g[1]]);f.attenC.set(a,[g[2]])}else f.attenA.set(a,[0]),f.attenB.set(a,[0]),f.attenC.set(a,[0]);e.isaSpotLight?(f.cutOffAngleCos.set(a,[Math.cos(e.cutOffAngle())]),f.spotExp.set(a,[e.spotExponent()])):(f.cutOffAngleCos.set(a,[0]),f.spotExp.set(a,[0]))}for(d=c;d<TentaGL.LightsShader.MAX_LIGHTS;d++)f=this._lightsUni[d],f.type.set(a,[0]),f.pos.set(a,[0,0,0,0]),f.dir.set(a,[0,0,0]),f.diff.set(a,[0,0,0,0]),f.spec.set(a,[0,0,0,0]),f.amb.set(a,[0,0,0,0]),f.attenA.set(a,[0]),f.attenB.set(a,[0]),f.attenC.set(a,
[0]),f.cutOffAngleCos.set(a,[0]),f.spotExp.set(a,[0])}};TentaGL.PerVertexPhongShader.load=function(a,b){var c=new TentaGL.PerVertexPhongShader(a);TentaGL.ShaderLib.add(a,b,c);return c};Util.Inheritance.inherit(TentaGL.PerVertexPhongShader,TentaGL.ShaderProgram);
...
[1])},setMaterialProps:function(a,b){this._materialUni.diff.set(a,b.diffuse().getRGBA());this._materialUni.spec.set(a,b.specular().getRGBA());this._materialUni.amb.set(a,b.ambient().getRGBA());this._materialUni.emis.set(a,b.emission().getRGBA());this._materialUni.shininess.set(a,[b.shininess()])},setLights:function(a,b){var c=b[0];c.isaAmbientLight&&this._lightUni.type.set(a,[TentaGL.LightsShader.LIGHT_AMB]);c.isaPointLight&&this._lightUni.type.set(a,[TentaGL.LightsShader.LIGHT_PT]);c.isaDirectionalLight&&
this._lightUni.type.set(a,[TentaGL.LightsShader.LIGHT_DIR]);c.isaSpotLight&&this._lightUni.type.set(a,[TentaGL.LightsShader.LIGHT_SPOT]);c.isaPointLight?this._lightUni.pos.set(a,c.xyz()):this._lightUni.pos.set(a,[0,0,0,0]);c.isaDirectionalLight?this._lightUni.dir.set(a,c.direction()):this._lightUni.dir.set(a,[0,0,0]);this._lightUni.diff.set(a,c.diffuse().getRGBA());this._lightUni.spec.set(a,c.specular().getRGBA());this._lightUni.amb.set(a,c.ambient().getRGBA());if(c.isaPointLight){var d=c.attenuation();
this._lightUni.attenA.set(a,[d[0]]);this._lightUni.attenB.set(a,[d[1]]);this._lightUni.attenC.set(a,[d[2]])}else this._lightUni.attenA.set(a,[0]),this._lightUni.attenB.set(a,[0]),this._lightUni.attenC.set(a,[0]);c.isaSpotLight?(this._lightUni.cutOffAngleCos.set(a,[Math.cos(c.cutOffAngle())]),this._lightUni.spotExp.set(a,[c.spotExponent()])):(this._lightUni.cutOffAngleCos.set(a,[0]),this._lightUni.spotExp.set(a,[0]))}};
...
[b.length]);for(var d=0;d<c;d++){var e=b[d],f=this._lightsUni[d];e.isaAmbientLight&&f.type.set(a,[TentaGL.LightsShader.LIGHT_AMB]);e.isaPointLight&&f.type.set(a,[TentaGL.LightsShader.LIGHT_PT]);e.isaDirectionalLight&&f.type.set(a,[TentaGL.LightsShader.LIGHT_DIR]);e.isaSpotLight&&f.type.set(a,[TentaGL.LightsShader.LIGHT_SPOT]);e.isaPointLight?f.pos.set(a,e.xyz()):f.pos.set(a,[0,0,0,0]);e.isaDirectionalLight?f.dir.set(a,e.direction()):f.dir.set(a,[0,0,0]);f.diff.set(a,e.diffuse().getRGBA());f.spec.set(a,
e.specular().getRGBA());f.amb.set(a,e.ambient().getRGBA());if(e.isaPointLight){var g=e.attenuation();f.attenA.set(a,[g[0]]);f.attenB.set(a,[g[1]]);f.attenC.set(a,[g[2]])}else f.attenA.set(a,[0]),f.attenB.set(a,[0]),f.attenC.set(a,[0]);e.isaSpotLight?(f.cutOffAngleCos.set(a,[Math.cos(e.cutOffAngle())]),f.spotExp.set(a,[e.spotExponent()])):(f.cutOffAngleCos.set(a,[0]),f.spotExp.set(a,[0]))}for(d=c;d<TentaGL.LightsShader.MAX_LIGHTS;d++)f=this._lightsUni[d],f.type.set(a,[0]),f.pos.set(a,[0,0,0,0]),f.dir.set(a,
...
[1]);this._useBumpUni.set(a,[0])},setBump:function(a,b){this._bumpTexUni.set(a,[b]);this._useBumpUni.set(a,[1])},setMaterialProps:function(a,b){this._materialUni.diff.set(a,b.diffuse().getRGBA());this._materialUni.spec.set(a,b.specular().getRGBA());this._materialUni.amb.set(a,b.ambient().getRGBA());this._materialUni.emis.set(a,b.emission().getRGBA());this._materialUni.shininess.set(a,[b.shininess()])},setLights:function(a,b){var c=b[0];c.isaAmbientLight&&this._lightUni.type.set(a,[TentaGL.LightsShader.LIGHT_AMB]);
c.isaPointLight&&this._lightUni.type.set(a,[TentaGL.LightsShader.LIGHT_PT]);c.isaDirectionalLight&&this._lightUni.type.set(a,[TentaGL.LightsShader.LIGHT_DIR]);c.isaSpotLight&&this._lightUni.type.set(a,[TentaGL.LightsShader.LIGHT_SPOT]);c.isaPointLight?this._lightUni.pos.set(a,c.xyz()):this._lightUni.pos.set(a,[0,0,0,0]);c.isaDirectionalLight?this._lightUni.dir.set(a,c.direction()):this._lightUni.dir.set(a,[0,0,0]);this._lightUni.diff.set(a,c.diffuse().getRGBA());this._lightUni.spec.set(a,c.specular().getRGBA());
this._lightUni.amb.set(a,c.ambient().getRGBA());if(c.isaPointLight){var d=c.attenuation();this._lightUni.attenA.set(a,[d[0]]);this._lightUni.attenB.set(a,[d[1]]);this._lightUni.attenC.set(a,[d[2]])}else this._lightUni.attenA.set(a,[0]),this._lightUni.attenB.set(a,[0]),this._lightUni.attenC.set(a,[0]);c.isaSpotLight?(this._lightUni.cutOffAngleCos.set(a,[Math.cos(c.cutOffAngle())]),this._lightUni.spotExp.set(a,[c.spotExponent()])):(this._lightUni.cutOffAngleCos.set(a,[0]),this._lightUni.spotExp.set(a,
[0]))}};TentaGL.PhongShaderMac.load=function(a,b){var c=new TentaGL.PhongShaderMac(a);TentaGL.ShaderLib.add(a,b,c);return c};Util.Inheritance.inherit(TentaGL.PhongShaderMac,TentaGL.ShaderProgram);
