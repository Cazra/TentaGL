...
a.intersects(new TentaGL.Math.Line2D([d,b],[d,c]))||a.intersects(new TentaGL.Math.Line2D([e,b],[e,c]))},render:function(a,b){TentaGL.ViewTrans.push(a);b&&TentaGL.MaterialLib.use(a,b);TentaGL.ViewTrans.translate(a,this._xy);TentaGL.ViewTrans.scale(a,[this._w,this._h]);TentaGL.ModelLib.render(a,"unitPlane");TentaGL.ViewTrans.pop(a)}};Util.Inheritance.inherit(TentaGL.Math.Rect2D,TentaGL.Math.Shape2D);
TentaGL.Math.Triangle2D=function(a,b,c){this._a=vec2.copy([],a);this._b=vec2.copy([],b);this._c=vec2.copy([],c);this._updateMetrics()};
...
TentaGL.UIComponent=function(a){a||(a=[0,0,0]);TentaGL.Sprite.call(this,a);this._parentComponent=void 0;this.enabled(!0);this._resetMouseState()};
TentaGL.UIComponent.prototype={constructor:TentaGL.UIComponent,isaUIComponent:!0,_resetMouseState:function(){this._isRightPressed=this._isLeftPressed=!1;this._mouseOverStart=-1;this._tooltipPosition=void 0},updateMouseState:function(a,b){if(a.getSpriteAtMouse(b)==this){if(this._enabled){-1==this._mouseOverStart&&(this._mouseOverStart=Date.now(),this.onMouseOver(b));if(b.isLeftPressed())this._isLeftPressed=!0;else{if(this._isLeftPressed)this.onClick(b);this._isLeftPressed=!1}if(b.isRightPressed())this._isRightPressed=
!0;else{if(this._isRightPressed)this.onRightClick(b);this._isRightPressed=!1}}this._tooltipPosition=b.getXY();vec2.add(this._tooltipPosition,this._tooltipPosition,[0,16])}else{if(0<=this._mouseOverStart&&this._enabled)this.onMouseExit(b);this._resetMouseState()}},isPressed:function(){return this._isLeftPressed},timeMouseOvered:function(){return-1==this._mouseOverStart?-1:Date.now()-this._mouseOverStart},isMouseOvered:function(){return 0<=this._mouseOverStart},enabled:function(a){void 0!==a&&(this._enabled=
a);return this._enabled},setTooltip:function(a,b){this._tooltip=b;this._tooltipText=a},onClick:function(a){},onRightClick:function(a){},onMouseOver:function(a){},onMouseExit:function(a){}};Util.Inheritance.inherit(TentaGL.UIComponent,TentaGL.Sprite);TentaGL.ButtonSprite=function(a,b){TentaGL.UIComponent.call(this,a);b||(b=function(){});this.onClick=function(a){b()}};TentaGL.ButtonSprite.prototype={constructor:TentaGL.ButtonSprite,isaButtonSprite:!0};Util.Inheritance.inherit(TentaGL.ButtonSprite,TentaGL.UIComponent);
TentaGL.ButtonSprite.create=function(a,b,c,d,e){a=new TentaGL.ButtonSprite(a);e||(e=new TentaGL.MaterialProps);a.draw=function(a){try{TentaGL.ShaderLib.use(a,d),TentaGL.MaterialLib.use(a,c),e.useMe(a),TentaGL.ModelLib.render(a,b)}catch(g){}TentaGL.ButtonSprite.prototype.draw.call(this,a)};return a};TentaGL.Tooltip=function(a,b,c,d){this._bgMatName=b;this._blitFont=a;this._pad=c;this._delay=d;this.text("")};
TentaGL.Tooltip.getDefault=function(a){if(!a._defaultTooltip){var b=new TentaGL.Font("Arial","sans-serif",10),c=new TentaGL.Color([.8,.8,.8,1]),b=TentaGL.BlitteredFont.fromFont(b,c,1,1,function(a){return a=a.filter(TentaGL.RGBAFilter.OutlineColor.RGBBytes(150,150,200))});a._defaultTooltip=new TentaGL.Tooltip(b,"_defaultTooltipBGColor",4,1E3)}return a._defaultTooltip};
TentaGL.Tooltip.prototype={constructor:TentaGL.Tooltip,isaTooltip:!0,text:function(a){this._text=a;this._dims=this._blitFont.getStringDimensions("")},component:function(a){},getDimensions:function(){return[this._dims[0]+2*this._pad,this._dims[1]+2*this._pad]},padding:function(a){void 0!==a&&(this._pad=a);return this._pad},delay:function(a){void 0!==a&&(this._delay=a);return this._delay},render:function(a,b,c){b&&this.text(b);c&&TentaGL.ViewTrans.translate(a,c);b=this.getDimensions();TentaGL.MaterialLib.use(a,
this._bgMatName);TentaGL.ViewTrans.push(a);TentaGL.ViewTrans.scale(a,b);TentaGL.ModelLib.render(a,"unitSprite");TentaGL.ViewTrans.pop(a);this._blitFont.renderString(a,this._text,[this._pad,this._pad],!0)}};Util.Inheritance.inherit(TentaGL.Tooltip,TentaGL.Renderable);