...
TentaGL.PointLight=function(a,b,c,d){TentaGL.Light.call(this,b,c,d);this._xyz=vec4.clone(a);this._xyz[3]=1;this._attenuation=[1,0,0]};TentaGL.PointLight.prototype={constructor:TentaGL.PointLight,isaPointLight:!0,xyz:function(a){void 0!==a&&(this._xyz=vec3.copy([],a),this._xyz[3]=1);return this._xyz},attenuation:function(a){void 0!==a&&(this._attenuation=a.slice(0));return this._attenuation},render:function(a){(new TentaGL.Math.Sphere(1,this._xyz)).render(a)}};
...
this._labelBG.render(a);TentaGL.ViewTrans.pop(a)}}};Util.Inheritance.inherit(TentaGL.LabelledIconSprite,TentaGL.Sprite);TentaGL.TextSprite=function(a,b,c,d,e){TentaGL.Sprite.call(this,a);d||(d=!1);this._blitFont=c;this._charH=e;this._yFlipped=d;this.setText(b)};
