...
a);return!0}return!1},_getPixelAt:function(a,b,c){return this._pixels.getPixelAt(a,b,c)},getSpriteAt:function(a,b){if(this._pixels){var c=this._getPixelAt(a,b),c=TentaGL.Color.rgba2hex(c);return this._sprites[c]}},getSpriteAtMouse:function(a){var b=a.getX();a=this._app.getHeight()-a.getY();return this.getSpriteAt(b,a)}};TentaGL.AppResizeListener=function(){};TentaGL.AppResizeListener.prototype={constructor:TentaGL.AppResizeListener,isaAppResizeListener:!0,handleAppResizeEvent:function(a){}};
...
TentaGL.Color.HSBA=function(a){var b=new TentaGL.Color;b.hsba(a);return b};TentaGL.Color.HSB=function(a){return TentaGL.Color.HSBA(a)};TentaGL.Color.rgba2hex=function(a){void 0===a[3]&&(a[3]=255);var b=a[3]<<24,b=b+(a[0]<<16),b=b+(a[1]<<8),b=b+a[2];return b>>>0};TentaGL.Color.hex2rgba=function(a){return vec4.fromValues((a>>>16&255)/255,(a>>>8&255)/255,(a&255)/255,(a>>>24&255)/255)};
TentaGL.Color.rgba2hsba=function(a){var b=a[0],c=a[1],d=a[2];a=a[3];void 0===a&&(a=1);var e=Math.max(b,c,d),f=Math.min(b,c,d),f=e-f,g=0,g=0==f?0:e==b?(c-d)/f%6:(e=c)?(d-b)/f+2:(b-c)/f+4,b=e,c=0;0!=f&&(c=f/b);return[g/6,c,b,a]};
...
cursor:function(a){void 0!==a&&(this._cursorStyle=a);return this._cursorStyle},_resetMouseState:function(){this._isRightPressed=this._isLeftPressed=!1;this._mouseOverStart=-1;this._tooltipPos=void 0;this._tooltip&&this._tooltip.component()==this&&(this._tooltip.reset(),console.log("stop tooltip"))},updateMouseState:function(a,b){if(a.getSpriteAtMouse(b)==this){if(this._enabled){-1==this._mouseOverStart&&(this._mouseOverStart=Date.now(),this.onMouseOver(b));if(b.isLeftPressed())this._isLeftPressed=
!0;else{if(this._isLeftPressed)this.onClick(b);this._isLeftPressed=!1}if(b.isRightPressed())this._isRightPressed=!0;else{if(this._isRightPressed)this.onRightClick(b);this._isRightPressed=!1}b.getCanvas().style.cursor=this._cursorStyle}this._tooltip&&this.timeMouseOvered()>=this._tooltip.delay()&&(this._tooltip.component(this),this._tooltip.xy(vec2.add([],b.getXY(),[0,16])),this._tooltip.text(this._tooltipText),console.log(this._tooltip))}else{if(0<=this._mouseOverStart&&this._enabled)this.onMouseExit(b);
console.log("no longer mouseover.");this._resetMouseState()}},isPressed:function(){return this._isLeftPressed},timeMouseOvered:function(){return-1==this._mouseOverStart?-1:Date.now()-this._mouseOverStart},isMouseOvered:function(){return 0<=this._mouseOverStart},enabled:function(a){void 0!==a&&(this._enabled=a);return this._enabled},setTooltip:function(a,b){this._tooltip=b;this._tooltipText=a},onClick:function(a){},onRightClick:function(a){},onMouseOver:function(a){},onMouseExit:function(a){}};
Util.Inheritance.inherit(TentaGL.UI.Component,TentaGL.Sprite);TentaGL.UI.Button=function(a,b){TentaGL.UI.Component.call(this,a);b||(b=function(){});this.onClick=function(a){b()}};TentaGL.UI.Button.prototype={constructor:TentaGL.UI.Button,isaButtonSprite:!0};Util.Inheritance.inherit(TentaGL.UI.Button,TentaGL.UI.Component);
