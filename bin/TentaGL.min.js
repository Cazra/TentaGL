...
var TentaGL={versionMajor:0,versionMinor:17,createGL:function(a,b){b=b||{alpha:!1};try{var c=a.getContext("webgl",b)||a.getContext("experimental-webgl",b)||a.getContext("webkit-3d",b)||a.getContext("moz-webgl",b);TentaGL.Blend.reset(c);TentaGL.Cull.reset(c);TentaGL.DepthBuffer.reset(c);TentaGL.Scissor.reset(c);TentaGL.Stencil.reset(c);TentaGL.Viewport.set(c,[0,0,a.width,a.height]);TentaGL.ViewTrans.reset(c);this._normalTrans=mat3.create();this._mvpTrans=mat4.create();return c}catch(d){throw Error("Error creating WebGL context: "+
d.toString());}},createCanvas:function(a){var b=document.createElement("canvas");a.appendChild(b);b.width=a.offsetWidth;b.height=a.offsetHeight;return b},clear:function(a,b){TentaGL.ColorBuffer.setClearColor(a,b);a.clear(GL_COLOR_BUFFER_BIT|GL_DEPTH_BUFFER_BIT)},glTypeName:function(a){return TentaGL._glTypeName[a]},glSizeUnits:function(a){return TentaGL._glSizeUnits[a]},glSizeBytes:function(a){var b=TentaGL.glSizeUnits(a);a=TentaGL.glUnitType(a);return b*TentaGL._glSizeBytes[a]},glUnitType:function(a){return TentaGL._glUnitTypes[a]},
_defaultRenderFilter:function(a){return!0},_glTypeName:[]};TentaGL._glTypeName[GL_BYTE]="BYTE";TentaGL._glTypeName[GL_UNSIGNED_BYTE]="UNSIGNED_BYTE";TentaGL._glTypeName[GL_SHORT]="SHORT";TentaGL._glTypeName[GL_UNSIGNED_SHORT]="UNSIGNED_SHORT";TentaGL._glTypeName[GL_INT]="INT";TentaGL._glTypeName[GL_UNSIGNED_INT]="UNSIGNED_INT";TentaGL._glTypeName[GL_FLOAT]="FLOAT";TentaGL._glTypeName[GL_FLOAT_VEC2]="FLOAT_VEC2";TentaGL._glTypeName[GL_FLOAT_VEC3]="FLOAT_VEC3";TentaGL._glTypeName[GL_FLOAT_VEC4]="FLOAT_VEC4";
TentaGL._glTypeName[GL_INT_VEC2]="INT_VEC2";TentaGL._glTypeName[GL_INT_VEC3]="INT_VEC3";TentaGL._glTypeName[GL_INT_VEC4]="INT_VEC4";TentaGL._glTypeName[GL_BOOL]="BOOL";TentaGL._glTypeName[GL_BOOL_VEC2]="BOOL_VEC2";TentaGL._glTypeName[GL_BOOL_VEC3]="BOOL_VEC3";TentaGL._glTypeName[GL_BOOL_VEC4]="BOOL_VEC4";TentaGL._glTypeName[GL_FLOAT_MAT2]="FLOAT_MAT2";TentaGL._glTypeName[GL_FLOAT_MAT3]="FLOAT_MAT3";TentaGL._glTypeName[GL_FLOAT_MAT4]="FLOAT_MAT4";TentaGL._glTypeName[GL_SAMPLER_2D]="SAMPLER_2D";
TentaGL._glTypeName[GL_SAMPLER_CUBE]="SAMPLER_CUBE";TentaGL._glSizeUnits=[];TentaGL._glSizeUnits[GL_BYTE]=1;TentaGL._glSizeUnits[GL_UNSIGNED_BYTE]=1;TentaGL._glSizeUnits[GL_SHORT]=1;TentaGL._glSizeUnits[GL_UNSIGNED_SHORT]=1;TentaGL._glSizeUnits[GL_INT]=1;TentaGL._glSizeUnits[GL_UNSIGNED_INT]=1;TentaGL._glSizeUnits[GL_FLOAT]=1;TentaGL._glSizeUnits[GL_FLOAT_VEC2]=2;TentaGL._glSizeUnits[GL_FLOAT_VEC3]=3;TentaGL._glSizeUnits[GL_FLOAT_VEC4]=4;TentaGL._glSizeUnits[GL_INT_VEC2]=2;
TentaGL._glSizeUnits[GL_INT_VEC3]=3;TentaGL._glSizeUnits[GL_INT_VEC4]=4;TentaGL._glSizeUnits[GL_BOOL]=1;TentaGL._glSizeUnits[GL_BOOL_VEC2]=2;TentaGL._glSizeUnits[GL_BOOL_VEC3]=3;TentaGL._glSizeUnits[GL_BOOL_VEC4]=4;TentaGL._glSizeUnits[GL_FLOAT_MAT2]=4;TentaGL._glSizeUnits[GL_FLOAT_MAT3]=9;TentaGL._glSizeUnits[GL_FLOAT_MAT4]=16;TentaGL._glSizeBytes=[];TentaGL._glSizeBytes[GL_BYTE]=1;TentaGL._glSizeBytes[GL_UNSIGNED_BYTE]=1;TentaGL._glSizeBytes[GL_SHORT]=2;TentaGL._glSizeBytes[GL_UNSIGNED_SHORT]=2;
TentaGL._glSizeBytes[GL_INT]=4;TentaGL._glSizeBytes[GL_UNSIGNED_INT]=4;TentaGL._glSizeBytes[GL_FLOAT]=4;TentaGL._glSizeBytes[GL_BOOL]=4;TentaGL._glUnitTypes=[];TentaGL._glUnitTypes[GL_BYTE]=GL_BYTE;TentaGL._glUnitTypes[GL_UNSIGNED_BYTE]=GL_UNSIGNED_BYTE;TentaGL._glUnitTypes[GL_SHORT]=GL_SHORT;TentaGL._glUnitTypes[GL_UNSIGNED_SHORT]=GL_UNSIGNED_SHORT;TentaGL._glUnitTypes[GL_INT]=GL_INT;TentaGL._glUnitTypes[GL_UNSIGNED_INT]=GL_UNSIGNED_INT;TentaGL._glUnitTypes[GL_FLOAT]=GL_FLOAT;
TentaGL._glUnitTypes[GL_FLOAT_VEC2]=GL_FLOAT;TentaGL._glUnitTypes[GL_FLOAT_VEC3]=GL_FLOAT;TentaGL._glUnitTypes[GL_FLOAT_VEC4]=GL_FLOAT;TentaGL._glUnitTypes[GL_INT_VEC2]=GL_INT;TentaGL._glUnitTypes[GL_INT_VEC3]=GL_INT;TentaGL._glUnitTypes[GL_INT_VEC4]=GL_INT;TentaGL._glUnitTypes[GL_BOOL]=GL_BOOL;TentaGL._glUnitTypes[GL_BOOL_VEC2]=GL_BOOL;TentaGL._glUnitTypes[GL_BOOL_VEC3]=GL_BOOL;TentaGL._glUnitTypes[GL_BOOL_VEC4]=GL_BOOL;TentaGL._glUnitTypes[GL_FLOAT_MAT2]=GL_FLOAT;
TentaGL._glUnitTypes[GL_FLOAT_MAT3]=GL_FLOAT;TentaGL._glUnitTypes[GL_FLOAT_MAT4]=GL_FLOAT;var Util;Util||(Util={});Util.Debug={arrayString:function(a){for(var b="[",c=!0,d=0;d<a.length;d++)c?c=!1:b+=", ",b+=a[d];return b+"]"},objString:function(a){var b="{",c=!0,d;for(d in a)c?c=!1:b+=", ",b+=d+":"+a[d];return b+"}"}};
...
Util.Downloader={invisInput:void 0,saveAsText:function(a,b){var c=document.createElement("a");c.href="data:text;charset=utf-8,"+encodeURIComponent(b);c.download=a;c.click()},openDialog:function(a){var b=document.createElement("INPUT");b.setAttribute("type","file");b.style.display="none";var c=document.getElementsByTagName("body")[0];c.appendChild(b);b.onchange=function(d){console.log("derp");var e=new FileReader;e.onload=function(d){console.log("derp");a(d.target.result);c.removeChild(b)};e.readAsText(d.target.files[0])};
b.click()}};Util||(Util={});Util.Inheritance={inherit:function(a,b){for(var c in b.prototype)a.prototype[c]||(a.prototype[c]=b.prototype[c])}};
TentaGL.Blend={lock:function(a){a._blendLocked=!0},unlock:function(a){a._blendLocked=!1},setEnabled:function(a,b){a._blendEnabled==b||a._blendLocked||((a._blendEnabled=b)?a.enable(GL_BLEND):a.disable(GL_BLEND))},isEnabled:function(a){return a._blendEnabled},setEquation:function(a,b,c,d){a._blendEquation!=b&&(a._blendEquation=b,a.blendEquation(b));if(a._blendSrcFunc!=c||a._blendDstFunc!=d)a._blendSrcFunc=c,a._blendDstFunc=d,a.blendFunc(c,d)},getEquation:function(a){return a._blendEquation},getSrcFunc:function(a){return a._blendSrcFunc},
getDstFunc:function(a){return a._blendDstFunc},setBlendColor:function(a,b){var c=b.getRed(),d=b.getGreen(),e=b.getBlue(),f=b.getAlpha();if(a._blendRed!=c||a._blendGreen!=d||a._blendBlue!=e||a._blendAlpha!=f)a._blendRed=c,a._blendGreen=d,a._blendBlue=e,a._blendAlpha=f,a.blendColor(c,d,e,f)},getBlendColor:function(a){return TentaGL.Color.RGBA(a._blendRed,a._blendGreen,a._blendBlue,a._blendAlpha)},reset:function(a){a._blendLocked=!1;a._blendEnabled=!1;a._blendEquation=GL_FUNC_ADD;a._blendSrcFunc=GL_ONE;
a._blendDstFunc=GL_ZERO;a._blendRed=0;a._blendGreen=0;a._blendBlue=0;a._blendAlpha=0}};
TentaGL.ColorBuffer={reset:function(a){a._cbLock=!1;a._cbRed=0;a._cbGreen=0;a._cbBlue=0;a._cbAlpha=0;a._cbWriteRed=!0;a._cbWriteGreen=!0;a._cbWriteBlue=!0;a._cbWriteAlpha=!0},lock:function(a){a._cbLock=!0},unlock:function(a){a._cbLock=!1},setClearColor:function(a,b){a._cbLock||(a._cbRed=b.getRed(),a._cbGreen=b.getGreen(),a._cbBlue=b.getBlue(),a._cbAlpha=b.getAlpha(),a.clearColor(a._cbRed,a._cbGreen,a._cbBlue,a._cbAlpha))},getClearColor:function(a){return vec4.fromValues(a._cbRed,a._cbGreen,a._cbBlue,
a._cbAlpha)},setWriteable:function(a,b,c,d,e){a._cbWriteRed=b;a._cbWriteGreen=c;a._cbWriteBlue=d;a._cbWriteAlpha=e;a.colorMask(b,c,d,e)},clear:function(a,b){b&&this.setClearColor(a,b);a.clear(GL_COLOR_BUFFER_BIT)}};TentaGL.Cull={setMode:function(a,b){a._cullMode!=b&&(a._cullMode=b,b==GL_NONE?a.disable(GL_CULL_FACE):(a.enable(GL_CULL_FACE),a.cullFace(b)))},getMode:function(a){return a._cullMode},reset:function(a){a._cullMode=GL_NONE}};
TentaGL.DepthBuffer={reset:function(a){a._depthEnabled=!1;a._depthFunc=GL_LESS;a._depthWrite=!0;a._depthWinNear=0;a._depthWinFar=1;a._depthClearVal=1},setEnabled:function(a,b){a._depthEnabled!=b&&((a._depthEnabled=b)?a.enable(GL_DEPTH_TEST):a.disable(GL_DEPTH_TEST))},isTestEnabled:function(a){return a._depthEnabled},setFunc:function(a,b){a._depthFunc!=b&&(a._depthFunc=b,a.depthFunc(b))},getFunc:function(a){return a._depthFunc},setMaskEnabled:function(a,b){a._depthWrite!=b&&(a._depthWrite=b,a.depthMask(b))},
isMaskEnabled:function(a){return a._depthWrite},setRange:function(a,b,c){b=TentaGL.Math.clamp(b,0,1);c=TentaGL.Math.clamp(c,0,1);if(a._depthWinNear!=b||a._depthWinFar!=c)a._depthWinNear=b,a._depthWinFar=c,a.depthRange(b,c)},getRangeNear:function(a){return a._depthWinNear},getRangeFar:function(a){return a._depthWinFar},setClearValue:function(a,b){b=TentaGL.Math.clamp(b,0,1);a._depthClearVal!=b&&(a._depthClearVal=b,a.clearDepth(b))},getClearValue:function(){return gl._depthClearVal},clear:function(a){a.clear(GL_DEPTH_BUFFER_BIT)},
createBuffer:function(a,b,c){var d=a.createRenderbuffer();a.bindRenderbuffer(GL_RENDERBUFFER,d);a.renderbufferStorage(GL_RENDERBUFFER,GL_DEPTH_COMPONENT16,b,c);a.bindRenderbuffer(GL_RENDERBUFFER,null);return d}};
TentaGL.Scissor={reset:function(a){a._scissorX=0;a._scissorY=0;a._scissorWidth=1;a._scissorHeight=1;a._scissorEnabled=!1},set:function(a,b){b?(a._scissorX=b[0],a._scissorY=b[1],a._scissorWidth=b[2],a._scissorHeight=b[3],a._scissorEnabled=!0,a.enable(GL_SCISSOR_TEST),a.scissor(b[0],b[1],b[2],b[3])):(a._scissorEnabled=!1,a.disable(GL_SCISSOR_TEST))},get:function(a){return[a._scissorX,a._scissorY,a._scissorWidth,a._scissorHeight]},getX:function(a){return a._scissorX},getY:function(a){return a._scissorY},
getWidth:function(a){return a._scissorWidth},getHeight:function(a){return a._scissorHeight},isEnabled:function(a){return a._scissorEnabled},push:function(a){a._scissorStack||(a._scissorStack=[]);a._scissorStack.push(this.get(a))},pop:function(a){this.set(a,a._scissorStack.pop())}};
TentaGL.Stencil={reset:function(a){a._stencilEnabled=!1;a._stencilClearVal=0},setTestEnabled:function(a,b){a._stencilEnabled!=b&&((a._stencilEnabled=b)?a.enable(GL_STENCIL_TEST):a.disable(GL_STENCIL_TEST))},isStencilEnabled:function(){return gl._stencilEnabled},setClearValue:function(a,b){a._stencilClearVal!=b&&(a._stencilClearVal=b,a.clearStencil(b))},getClearValue:function(){return gl._stencilClearVal},createStencilBuffer:function(a,b,c){var d=a.createRenderbuffer();a.bindRenderbuffer(a.RENDERBUFFER,
d);a.renderbufferStorage(a.RENDERBUFFER,a.STENCIL_INDEX8,b,c);a.bindRenderbuffer(a.RENDERBUFFER,null);return d}};
TentaGL.Viewport={get:function(a){return[a._viewX,a._viewY,a._viewWidth,a._viewHeight]},getX:function(a){return a._viewX},getY:function(a){return a._viewY},getWidth:function(a){return a._viewWidth},getHeight:function(a){return a._viewHeight},set:function(a,b){a._viewX=b[0];a._viewY=b[1];a._viewWidth=b[2];a._viewHeight=b[3];a.viewport(b[0],b[1],b[2],b[3])},push:function(a){a._viewportStack||(a._viewportStack=[]);a._viewportStack.push(this.get(a))},pop:function(a){this.set(a,a._viewportStack.pop())}};
...
TentaGL.Math.Line3D=function(a,b){this._p1=vec4.clone(a);this._p1[3]=1;this._p2=vec4.clone(b);this._p2[3]=1;this._length=vec3.dist(a,b)};
TentaGL.Math.Line3D.prototype={constructor:TentaGL.Math.Line3D,isaLine3D:!0,clone:function(){return new TentaGL.Math.Line3D(this._p1,this._p2)},getPt1:function(){return this._p1},getPt2:function(){return this._p2},getLength:function(){return this._length},getVec3:function(){return vec3.sub(vec3.create(),this._p2,this._p1)},getQuat:function(){var a=this.getVec3();return TentaGL.Math.getQuatFromTo([1,0,0],a)},distToPt:function(a){var b=this.getVec3(),c=vec3.sub(vec3.create(),a,this._p1);a=vec3.sub(vec3.create(),
...
c*this._pt[2]]},getParallelVector:function(){var a=this._pt,b;if(0==this._normal[0])b=[a[0]+1,a[1],a[2]];else if(0==this._normal[1])b=[a[0],a[1]+1,a[2]];else if(0==this._normal[2])b=[a[0],a[1],a[2]+1];else{b=this.getCoefficients();var c=a[0]+1;b=[c,0,(-b[0]*c-b[3])/b[2]]}return vec3.sub(vec3.create(),b,a)},containsPt:function(a,b){b||(b=0);var c=this.getCoefficients();return Math.abs(c[0]*a[0]+c[1]*a[1]+c[2]*a[2]+c[3])<b},ptRelative:function(a){a=vec3.sub(vec3.create(),a,this._pt);vec3.normalize(a,
a);a=vec3.dot(this._nHat,a);return 0<a?1:0>a?-1:0},ptIsAbove:function(a){return 1==ptRelative(a)},ptIsBelow:function(a){return-1==ptRelative(a)},lineIntersection:function(a){var b=this.getPoint(),c=a.getPt1(),d=this.getNormal(),e=a.getVec3(),b=vec3.dot(d,vec3.sub(vec3.create(),b,c)),d=vec3.dot(d,e);if(0==d){if(0==b)return a}else return a=b/d,vec4.fromValues(c[0]+a*e[0],c[1]+a*e[1],c[2]+a*e[2],1)}};TentaGL.Math.Sphere=function(a,b){b||(b=[0,0,0]);this._pt=vec3.clone(b);this._radius=a};
TentaGL.Math.Sphere.prototype={constructor:TentaGL.Math.Sphere,isaSphere:!0,clone:function(){return new TentaGL.Math.Sphere(this._radius,this._pt)},getRadius:function(){return this._radius},getPoint:function(){return this._pt},distToPt:function(a){a=vec3.sub(vec3.create(),a,this._pt);return Math.abs(vec3.len(a)-this._radius)},containsPt:function(a){a=vec3.sub(vec3.create(),a,this._pt);return vec3.len(a)<=this._radius},surfaceContainsPt:function(a,b){b||(b=0);var c=vec3.sub(vec3.create(),a,this._pt);
return Math.abs(vec3.len(c)-this._radius)<=b},intersectsSphere:function(a){var b=vec3.sqrDist(this._pt,a._pt);a=this._radius+a._radius;return b<=a*a},intersectsPlane:function(a){return a.distToPt(this._pt)<=this._radius},render:function(a,b){var c=vec3.clone(this._pt),d=this._radius;TentaGL.ViewTrans.push(a);var e=mat4.create();mat4.translate(e,e,c);mat4.scale(e,e,[d,d,d]);TentaGL.ViewTrans.mul(a,e);TentaGL.ViewTrans.updateMVPUniforms(a);b&&TentaGL.MaterialLib.use(a,b);TentaGL.ModelLib.render(a,"unitSphere");
TentaGL.ViewTrans.pop(a)}};TentaGL.Application=function(a,b){console.log("TentaGL version "+TentaGL.versionMajor+"."+TentaGL.versionMinor);this._container=a;var c=TentaGL.createCanvas(a);this._gl=TentaGL.createGL(c,b);this._canvas=this._gl.canvas;this._keyboard=new TentaGL.Keyboard(a);this._mouse=new TentaGL.Mouse(c);this._picker=new TentaGL.Picker(this);a.onresize=function(){console.log(a.offsetWidth,a.offsetHeight)};this._resizeListeners=[]};
...
this._hardResetFlag=!1,this.start(),!0):!1},isPaused:function(){return this._isPaused},isRunning:function(){return this._isRunning},end:function(){this._endFlag=!0},hardReset:function(){this._hardResetFlag=!0},setPaused:function(a){a?this._isPaused=!0:this._isPaused&&(this._isPaused=!1,this._isRunning&&this.run(0))},getContainer:function(){return this._container},getCanvas:function(){return this._canvas},getGL:function(){return this._gl},getPicker:function(){return this._picker},getWidth:function(){return this._canvas.offsetWidth},
getHeight:function(){return this._canvas.offsetHeight},getAspectRatio:function(){return this.getWidth()/this.getHeight()},resize:function(a,b){var c=this.getCanvas(),d=this.getContainer(),e=this.getWidth(),f=this.getHeight();c.width=a;c.height=b;TentaGL.Viewport.set(this.getGL(),[0,0,a,b]);d.style.width=a;d.style.height=b;var c=new TentaGL.AppResizeEvent(this,a,b,e,f),g;for(g in this._resizeListeners)this._resizeListeners[g].handleAppResizeEvent(c)},addAppResizeListener:function(a){this._resizeListeners.push(a)},
removeAppResizeListener:function(a){a=this._resizeListeners.indexOf(a);if(-1==a)throw Error("Failed to unsubscribe AppResizeListener.");this._resizeListeners.splice(a,1)},keyboard:function(){return this._keyboard},mouse:function(){return this._mouse},initShaders:function(){},initMaterials:function(){},initModels:function(){},reset:function(){},update:function(){}};TentaGL.Level=function(a){this._app=a};
TentaGL.Level.prototype={constructor:TentaGL.Level,isaLevel:!0,getApp:function(){return this._app},keyboard:function(){return this._app.keyboard()},mouse:function(){return this._app.mouse()},clean:function(a){},reset:function(a){},update:function(a){},render:function(a){}};
...
this.getTransform(e);mat4.invert(d,d);vec4.transformMat4(a,a,d);a=new TentaGL.Math.Line3D(this._eye,a);if((b=b.lineIntersection(a))&&!b.isaLine3D)return b}};Util.Inheritance.inherit(TentaGL.Camera3D,TentaGL.Camera);
...
mat4.translate(b,b,vec3.negate(vec3.create(),this._center));return a=mat4.mul(a,a,b)}};Util.Inheritance.inherit(TentaGL.ArcballCamera,TentaGL.Camera3D);TentaGL.Picker=function(a){this._app=a;this._bytes=new Uint8Array(4)};TentaGL.Picker.SHADER_ID="pickShader";
TentaGL.Picker.prototype={constructor:TentaGL.Picker,update:function(a,b,c){this._pixels=void 0;this._origFilter=TentaGL.SceneNode.getRenderFilter();var d=TentaGL.ShaderLib.currentName(a);TentaGL.Blend.setEnabled(a,!1);TentaGL.Blend.lock(a);TentaGL.ColorBuffer.setClearColor(a,TentaGL.Color.RGBA(0,0,0,0));TentaGL.ColorBuffer.lock(a);TentaGL.MaterialLib.useNone(a);TentaGL.ShaderLib.use(a,TentaGL.Picker.SHADER_ID);TentaGL.ShaderLib.lock(a);this._nextID=1;this._sprites=[];this._gl=a;TentaGL.SceneNode.setRenderFilter(this._filterFunction.bind(this));
c&&(b(a),TentaGL.MaterialLib.useNone(a),this._nextID=1);c=this._app.getWidth();var e=this._app.getHeight(),f=c*e*4;f>this._bytes.length&&(this._bytes=new Uint8Array(f));f=new TentaGL.BufferTexture(a,c,e);f.renderToMe(a,b);this._pixels=f.getPixelData(a,0,0,c,e,this._bytes);f.clean(a);TentaGL.ShaderLib.unlock(a);TentaGL.Blend.unlock(a);TentaGL.ColorBuffer.unlock(a);TentaGL.ShaderLib.use(a,d);TentaGL.SceneNode.setRenderFilter(this._origFilter)},_filterFunction:function(a){if(this._origFilter(a)){var b=
this._nextID;this._nextID++;var c=new TentaGL.Color.Hex(b);this._sprites[b]=a;a=c.getRGBA();TentaGL.ShaderLib.current(this._gl).setPickID(this._gl,a);return!0}return!1},_getPixelAt:function(a,b,c){return this._pixels.getPixelAt(a,b,c)},getSpriteAt:function(a,b,c){if(this._pixels){a=this._getPixelAt(a,b);a=TentaGL.Color.rgba2Hex(a[0],a[1],a[2],a[3]);a=this._sprites[a];if(c||!a)return a;c=a.getCompositePath();return c[c.length-1]}},getSpriteAtMouse:function(a,b){var c=a.getX(),d=this._app.getHeight()-
a.getY();return this.getSpriteAt(c,d,b)}};TentaGL.AppResizeListener=function(){};TentaGL.AppResizeListener.prototype={constructor:TentaGL.AppResizeListener,isaAppResizeListener:!0,handleAppResizeEvent:function(a){}};TentaGL.Event=function(a,b){this._source=a;this._type=b};TentaGL.Event.prototype={constructor:TentaGL.Event,getSource:function(){return this._source},getType:function(){return this._type}};
TentaGL.AppResizeEvent=function(a,b,c,d,e){TentaGL.Event.call(this,a,0);this._width=b;this._height=c;this._oldWidth=d;this._oldHeight=e};TentaGL.AppResizeEvent.prototype={constructor:TentaGL.AppResizeEvent,getWidth:function(){return this._width},getHeight:function(){return this._height},getOldWidth:function(){return this._oldWidth},getOldHeight:function(){return this._oldHeight}};Util.Inheritance.inherit(TentaGL.AppResizeEvent,TentaGL.Event);
TentaGL.PickEvent=function(a,b){TentaGL.Event.call(this,a,void 0);this._context=b};TentaGL.PickEvent.prototype={constructor:TentaGL.PickEvent,getContext:function(){return this._context}};Util.Inheritance.inherit(TentaGL.PickEvent,TentaGL.Event);TentaGL.PickEventListener=function(){};TentaGL.PickEventListener.prototype={constructor:TentaGL.PickEventListener,handlePickEvent:function(a){}};
TentaGL.Model=function(a,b){a||(a=GL_TRIANGLES);b||(b=GL_NONE);this._mode=a;this._cull=b;this._vertices=[];this._indices=[]};
...
TentaGL.Model.Cone=function(a,b,c){var d=new TentaGL.Model;c||(c=TentaGL.TAU/20);for(var e=Math.floor(TentaGL.TAU/c)+1,f=0;f<e;f++){var g=TentaGL.Math.toCartesian([a,f*c,0]),k=g[0],m=g[2],g=(k/a+1)/2,h=(m/a+1)/2,k=new TentaGL.Vertex(k,0,m);k.setNormal(0,-1,0);k.setTexST(g,h);d.addVertex(k)}for(f=0;f<e;f++){var g=f*c,l=TentaGL.Math.toCartesian([a,g,0]),h=l[0],m=l[2],k=(f+.5)*c,p=TentaGL.Math.toCartesian([a,k,0]),n=p[0],r=p[2],l=vec3.sub(vec3.create(),[0,b,0],l),q=vec3.fromValues(h,0,m),q=vec3.cross(vec3.create(),
q,l),l=vec3.cross(vec3.create(),l,q);vec3.normalize(l,l);p=vec3.sub(vec3.create(),[0,b,0],p);n=vec3.fromValues(n,0,r);n=vec3.cross(vec3.create(),n,p);n=vec3.cross(vec3.create(),p,n);vec3.normalize(n,n);h=new TentaGL.Vertex(h,0,m);h.setTexST(g/TentaGL.TAU,0);h.setNormal(l[0],l[1],l[2]);g=new TentaGL.Vertex(0,b,0);g.setTexST(k/TentaGL.TAU,1);g.setNormal(n[0],n[1],n[2]);d.addVertex(h);d.addVertex(g)}l=TentaGL.Math.toCartesian([a,0,0]);h=l[0];m=l[2];l=vec3.sub(vec3.create(),[0,b,0],l);q=vec3.fromValues(h,
0,m);q=vec3.cross(vec3.create(),q,l);l=vec3.cross(vec3.create(),l,q);vec3.normalize(l,l);h=new TentaGL.Vertex(h,0,m);h.setTexST(TentaGL.TAU,0);h.setNormal(l[0],l[1],l[2]);d.addVertex(h);for(a=2;a<e;a++)b=0,c=a-1,f=a,d.addFace(b,f,c);for(a=0;a<2*e;a+=2)b=e+(a+0),c=e+(a+2),f=e+(a+1),d.addFace(b,c,f);return d};
...
TentaGL.Model.Cylinder=function(a,b,c){var d=new TentaGL.Model(!1);c||(c=TentaGL.TAU/20);for(var e=Math.floor(TentaGL.TAU/c)+1,f=0;f<e;f++){var g=f*c,k=TentaGL.Math.toCartesian([a,g,0]),m=k[0],k=k[2],g=(m/a+1)/2,h=(k/a+1)/2,l=new TentaGL.Vertex(m,0,k);l.setNormal(0,-1,0);l.setTexST(g,h);d.addVertex(l)}for(f=0;f<e;f++)g=f*c,k=TentaGL.Math.toCartesian([a,g,0]),m=k[0],k=k[2],g/=TentaGL.TAU,l=new TentaGL.Vertex(m,0,k),l.setNormal(m,0,k),l.setTexST(g,0),d.addVertex(l);for(f=0;f<e;f++)g=f*c,k=TentaGL.Math.toCartesian([a,
g,0]),m=k[0],k=k[2],g/=TentaGL.TAU,l=new TentaGL.Vertex(m,b,k),l.setNormal(m,0,k),l.setTexST(g,1),d.addVertex(l);for(f=0;f<e;f++)g=f*c,k=TentaGL.Math.toCartesian([a,g,0]),m=k[0],k=k[2],g=(m/a+1)/2,h=(k/a+1)/2,l=new TentaGL.Vertex(m,b,k),l.setNormal(0,1,0),l.setTexST(g,h),d.addVertex(l);for(a=2;a<e;a++)b=0,c=a-1,f=a,d.addFace(b,f,c);for(a=0;a<e-1;a++)b=1*e+(a+0),c=1*e+(a+1),f=2*e+(a+1),d.addFaceQuad(b,c,f,2*e+(a+0));for(a=2;a<e;a++)b=3*e,c=3*e+a-1,f=3*e+a,d.addFace(b,c,f);return d};
...
TentaGL.Model.Sphere=function(a,b,c){var d=new TentaGL.Model;b||(b=TentaGL.TAU/20);c||(c=TentaGL.TAU/20);for(var e=Math.floor(TentaGL.TAU/2/b)+1,f=Math.floor(TentaGL.TAU/c)+1,g=0;g<e;g++)for(var k=g*b-TentaGL.TAU/4,m=0;m<f;m++){var h=m*c,l=TentaGL.Math.toCartesian([a,h,k]),p=l[0],n=l[1],l=l[2],h=h/TentaGL.TAU,r=k/(TentaGL.TAU/2)+.5,q=new TentaGL.Vertex(p,n,l);q.setNormal(p,n,l);q.setTexST(h,r);d.addVertex(q)}for(g=0;g<e-1;g++)for(m=0;m<f-1;m++)d.addFaceQuad((g+0)*f+(m+0),(g+0)*f+(m+1),(g+1)*f+(m+
...
TentaGL.Model.ObjReader={_numLoading:0,fromURL:function(a,b){var c=this,d=new XMLHttpRequest;d.open("get",a);d.onerror=function(a){console.log("AJAX error: ",a);c._numLoading--};d.onreadystatechange=function(a){4==this.readyState&&200==this.status&&(c._processResponse(d.responseText,b),c._numLoading--)};d.send();this._numLoading++},_processResponse:function(a,b){for(var c=[],d="",e=new TentaGL.Model,f=0,g="",k=a.split("\n"),m=0;m<k.length;m++){for(var h=k[m].trim(),h=h.replace("\t"," ");-1!=h.indexOf("  ");)h=
h.replace("  "," ");if(""!=h&&"#"!=h.charAt(0)){h=h.split(" ");h[0]!=g&&(f=0);if("g"==h[0])c[d]=e,e=new TentaGL.Model,d=h[1];else if("v"==h[0]){var l=parseFloat(h[1]),p=parseFloat(h[2]),n=parseFloat(h[3]);e.addVertex(new TentaGL.Vertex(l,p,n))}else if("vn"==h[0])g=e.getVertex(f),l=parseFloat(h[1]),p=parseFloat(h[2]),n=parseFloat(h[3]),g.setNormal(l,p,n);else if("vt"==h[0])g=e.getVertex(f),l=parseFloat(h[1]),p=parseFloat(h[2]),g.setTexST(l,p);else if("f"==h[0])g=parseInt(h[1])-1,l=parseInt(h[2])-1,
p=parseInt(h[3])-1,5==h.length?(n=parseInt(h[4])-1,e.addFaceQuad(g,l,p,n)):e.addFace(g,l,p);else if("usemtl"!=h[0])throw Error("Could not read wavefront object. Error at line "+(m+1));f++;g=h[0]}}c[d]=e;b(c)},isLoading:function(){return 0<this._numLoading},getNumLoading:function(){return this._numLoading}};TentaGL.Vertex=function(a,b,c){this._xyz=vec4.fromValues(a,b,c,1)};
TentaGL.Vertex.prototype={constructor:TentaGL.Vertex,getXYZ:function(){return vec4.clone(this._xyz)},setXYZ:function(a,b,c){this._xyz[0]=a;this._xyz[1]=b;this._xyz[2]=c},getX:function(){return this._xyz[0]},getY:function(){return this._xyz[1]},getZ:function(){return this._xyz[2]},setX:function(a){this._xyz[0]=a},setY:function(a){this._xyz[1]=a},setZ:function(a){this._xyz[2]=a},getTexST:function(){if(void 0===this._texST)throw Error("Vertex 2D texture coordinates have not been defined.");return vec2.clone(this._texST)},
hasTexST:function(){return void 0!=this._texST},setTexST:function(a,b){this._texST=vec2.fromValues(a,b)},getTexS:function(){return this._texST[0]},getTexT:function(){return this._texST[1]},getNormal:function(){if(void 0===this._normal)throw Error("Vertex surface normal has not been defined.");return vec3.clone(this._normal)},hasNormal:function(){return void 0!=this._normal},setNormal:function(a,b,c){this._normal=vec3.fromValues(a,b,c);this._normal=vec3.normalize(this._normal,this._normal)},getTangental:function(){if(void 0===
this._tangental)throw Error("Vertex surface tangental has not been defined.");return vec3.clone(this._tangental)},hasTangental:function(){return void 0!==this._tangental},computeTangental:function(a,b){var c=vec3.sub(vec3.create(),a.getXYZ(),this.getXYZ()),d=vec3.sub(vec3.create(),b.getXYZ(),this.getXYZ()),e=a.getTexS()-this.getTexS(),f=b.getTexS()-this.getTexS(),g=a.getTexT()-this.getTexT(),k=b.getTexT()-this.getTexT(),e=k*e-g*f;if(0==e)return vec3.fromValues(1,0,0);f=vec3.create();vec3.scale(f,
c,k);vec3.sub(f,f,vec3.scale(vec3.create(),d,g));vec3.scale(f,f,1/e);return 0==vec3.length(f)?vec3.fromValues(1,0,0):f},setTangental:function(a){this._tangental=vec3.fromValues(a[0],a[1],a[2]);this._tangental=vec3.normalize(this._tangental,this._tangental)},clone:function(){return this.transform(mat4.create())},transform:function(a){var b=vec4.transformMat4(vec4.create(),this.getXYZ(),a),b=new TentaGL.Vertex(b[0],b[1],b[2]);if(void 0!==this._normal){var c=this.getNormal(),c=vec4.fromValues(c[0],c[1],
c[2],0),c=vec4.transformMat4(c,c,a);b.setNormal(c[0],c[1],c[2])}void 0!==this._tangental&&(c=this.getTangental(),c=vec4.fromValues(c[0],c[1],c[2],0),c=vec4.transformMat4(c,c,a),b.setTangental(c[0],c[1],c[2]));void 0!==this._texST&&b.setTexST(this.getTexS(),this.getTexT());return b}};
...
TentaGL.RGBAFilter.Convolution.prototype={constructor:TentaGL.RGBAFilter.Convolution,getMatrix:function(){return this._matrix},getSideLength:function(){return this._sideLen},filter:function(a,b,c,d,e){for(var f=0,g=0,k=0,m=b[c+3],h=this._sideLen,l=TentaGL.PixelData.indexToXY(c,d),p=l[0],l=l[1],n=Math.floor(h/2),r=0;r<h;r++){var q=l+r-n;q>=e&&(q=e-1);0>q&&(q=0);for(var t=0;t<h;t++){var u=this._matrix[r][t],s=p+t-n;s>=d&&(s=d-1);0>s&&(s=0);var s=TentaGL.PixelData.xyToIndex(s,q,d),w=b[s+3]/255,f=f+b[s]*
u*w,g=g+b[s+1]*u*w,k=k+b[s+2]*u*w}}f=TentaGL.Math.clamp(f,-256,255);0>f&&(f+=256);g=TentaGL.Math.clamp(g,-256,255);0>g&&(g+=256);k=TentaGL.Math.clamp(k,-256,255);0>k&&(k+=256);this.setPixel(a,c,f,g,k,m)}};Util.Inheritance.inherit(TentaGL.RGBAFilter.Convolution,TentaGL.RGBAFilter);TentaGL.RGBAFilter.Convolution.Blur3=function(){return new TentaGL.RGBAFilter.Convolution([[1,1,1],[1,1,1],[1,1,1]])};
...
TentaGL.RGBAFilter.OutlineColor.prototype={constructor:TentaGL.RGBAFilter.OutlineColor,getColor:function(){return this._color},filter:function(a,b,c,d,e){var f=b[c],g=b[c+1],k=b[c+2],m=b[c+3];if(255!=m)for(var h=TentaGL.PixelData.indexToXY(c,d),l=h[0],h=h[1],p=-1;1>=p;p++){var n=h+p;if(!(n>=e||0>n))for(var r=-1;1>=r;r++){var q=l+r;if(!(q>=d||0>q)&&(q=TentaGL.PixelData.xyToIndex(q,n,d),255==b[q+3]))return f=this._color.getRedByte(),g=this._color.getGreenByte(),k=this._color.getBlueByte(),this.setPixel(a,
c,f,g,k,255)}}this.setPixel(a,c,f,g,k,m)}};TentaGL.RGBAFilter.OutlineColor.RGBBytes=function(a,b,c){a=TentaGL.Color.RGBABytes(a,b,c);return new TentaGL.RGBAFilter.OutlineColor(a)};Util.Inheritance.inherit(TentaGL.RGBAFilter.OutlineColor,TentaGL.RGBAFilter);TentaGL.RGBAFilter.SubColor=function(a){this._color=a};
...
a.onmousedown=function(a){b._pressedSinceLast[a.which]=!0;var d=Date.now(),e=d-b._lastClickTime[a.which];b._lastClickTime[a.which]=d;e<b._multiClickTime?b._clickCount[a.which]++:b._clickCount[a.which]=1};a.onmouseup=function(a){b._releasedSinceLast[a.which]=!0};a.onwheel=a.onmousewheel=function(a){var d=a.wheelDeltaY;void 0===d&&(d=a.deltaY);var e=a.wheelDeltaX;void 0===e&&(e=a.deltaX);var f=a.deltaZ;console.log(a);0>d?b._wheelTicksYSinceLast--:0<d&&b._wheelTicksYSinceLast++;0>e?b._wheelTicksXSinceLast--:
0<e&&b._wheelTicksXSinceLast++;0>f?b._wheelTicksZSinceLast--:0<f&&b._wheelTicksZSinceLast++;a.preventDefault()};a.onclick=function(a){b._fileOpenDialogCB&&(b._fileOpenDialogCB(),b._fileOpenDialogCB=void 0)}};TentaGL.Mouse.LEFT=1;TentaGL.Mouse.MIDDLE=2;TentaGL.Mouse.RIGHT=3;
TentaGL.Mouse.prototype={constructor:TentaGL.Mouse,poll:function(){this._justPressed=[];this._justReleased=[];this._wheelTicksX=this._wheelTicksXSinceLast;this._wheelTicksY=this._wheelTicksYSinceLast;this._wheelTicksY=this._wheelTicksZSinceLast;this._wheelTicksZSinceLast=this._wheelTicksYSinceLast=this._wheelTicksXSinceLast=0;this._mouseMoved=this._mouseMovedSinceLast;this._mouseMovedSinceLast=!1;for(var a in this._pressedSinceLast)this._isPressed[a]||(this._justPressed[a]=!0),this._isPressed[a]=
...
TentaGL.Color.prototype={constructor:TentaGL.Color,isaColor:!0,clean:function(a){},isLoaded:function(){return!0},getRGBA:function(){return vec4.clone(this._rgba)},getRGBABytes:function(){return vec4.fromValues(this.getRedByte(),this.getGreenByte(),this.getBlueByte(),this.getAlphaByte())},getRed:function(){return this._rgba[0]},getRedByte:function(){return 255*this._rgba[0]&255},getGreen:function(){return this._rgba[1]},getGreenByte:function(){return 255*this._rgba[1]&255},getBlue:function(){return this._rgba[2]},
getBlueByte:function(){return 255*this._rgba[2]&255},getAlpha:function(){return this._rgba[3]},getAlphaByte:function(){return 255*this._rgba[3]&255},setRGBA:function(a,b,c,d){this._rgba[0]=a;this._rgba[1]=b;this._rgba[2]=c;void 0!==d&&(this._rgba[3]=d);return this},setRed:function(a){this._rgba[0]=a;return this},setGreen:function(a){this._rgba[1]=a;return this},setBlue:function(a){this._rgba[2]=a;return this},setAlpha:function(a){this._rgba[3]=a;return this},setHex:function(a){return this.setRGBA((a>>>
16&255)/255,(a>>>8&255)/255,(a&255)/255,(a>>>24&255)/255)},getHex:function(){return TentaGL.Color.nrgba2Hex(this.getRed(),this.getGreen(),this.getBlue(),this.getAlpha())},setHSBA:function(a,b,c,d){void 0===d&&(d=this.getAlpha());a=TentaGL.Color.HSBAtoRGBA(a,b,c,d);this.setRGBA(rgab[0],a[1],a[2],a[3])},getHSBA:function(){var a=this.getRed(),b=this.getGreen(),c=this.getBlue(),d=this.getAlpha();return TentaGL.Color.RGBAtoHSBA(a,b,c,d)},getHue:function(){return this.getHSBA()[0]},setHue:function(a){var b=
this.getHSBA();this.setHSBA(a,b[1],b[2],b[3])},getSaturation:function(){return this.getHSBA()[1]},setSaturation:function(a){var b=this.getHSBA();this.setHSBA(b[0],a,b[2],b[3])},getBrightness:function(){return this.getHSBA()[2]},setBrightness:function(a){var b=this.getHSBA();this.setHSBA(b[0],b[1],a,b[3])},useMe:function(a){var b=TentaGL.ShaderLib.current(a);b.setColor&&b.setColor(a,this._rgba)},equals:function(a){return this.getRed()==a.getRed()&&this.getGreen()==a.getGreen()&&this.getBlue()==a.getBlue()&&
this.getAlpha()==a.getAlpha()},toCSS:function(){return"rgb("+this.getRedByte()+","+this.getGreenByte()+","+this.getBlueByte()+")"}};Util.Inheritance.inherit(TentaGL.Color,TentaGL.Material);TentaGL.Color.RGBA=function(a,b,c,d){return(new TentaGL.Color).setRGBA(a,b,c,d)};TentaGL.Color.RGBABytes=function(a,b,c,d){void 0===d&&(d=255);return(new TentaGL.Color).setRGBA(a/255,b/255,c/255,d/255)};TentaGL.Color.Hex=function(a){return(new TentaGL.Color).setHex(a)};
TentaGL.Color.HSBA=function(a,b,c,d){return(new TentaGL.Color).setHSBA(a,b,c,d)};TentaGL.Color.clone=function(a){return(new TentaGL.Color).setRGBA(a.getRed(),a.getGreen(),a.getBlue(),a.getAlpha())};TentaGL.Color.nrgba2Hex=function(a,b,c,d){d=Math.floor(255*d)<<24;d+=Math.floor(255*a)<<16;d+=Math.floor(255*b)<<8;d+=Math.floor(255*c);return d>>>0};TentaGL.Color.rgba2Hex=function(a,b,c,d){a=(d<<24)+(a<<16);a+=b<<8;a+=c;return a>>>0};
TentaGL.Color.RGBAtoHSBA=function(a,b,c,d){void 0===d&&(d=1);var e=Math.max(a,b,c),f=Math.min(a,b,c),f=e-f,g=0,g=0==f?0:e==a?(b-c)/f%6:(e=b)?(c-a)/f+2:(a-b)/f+4;a=e;b=0;0!=f&&(b=f/a);return[g/6,b,a,d]};TentaGL.Color.HSBAtoRGBA=function(a,b,c,d){void 0===d&&(d=1);a=6*(a-Math.floor(a));b*=c;var e=b*(1-Math.abs(a%2-1));c-=b;return 0<=a&&1>a?[b+c,e+c,c,d]:1<=a&&2>a?[e+c,b+c,c,d]:2<=a&&3>a?[c,b+c,e+c,d]:3<=a&&4>a?[c,e+c,b+c,d]:4<=a&&5>a?[e+c,c,b+c,d]:5<=a&&6>a?[b+c,c,e+c,d]:[c,c,c,d]};
...
TentaGL.Color.YELLOW=TentaGL.Color.Hex(4294967040);TentaGL.Gradient=function(a,b){this._pt=vec2.clone(a);this._vec=vec2.clone(b);this._breakPts=[]};
...
e,f)},useMe:function(a){a.activeTexture(a.TEXTURE0);a.bindTexture(a.TEXTURE_2D,this._tex);TentaGL.ShaderLib.current(a).setTex(a,0)}};Util.Inheritance.inherit(TentaGL.Texture,TentaGL.Material);
...
TentaGL.MaterialLib={_materials:{},clean:function(a){for(var b in a._materialLib)a._materialLib[b].clean(a);a._materialLib={}},reset:function(a){this.clean(a)},get:function(a,b){var c=a._materialLib[b];if(void 0===c)throw Error("Material "+b+" doesn't exist.");return c},has:function(a,b){return void 0!==a._materialLib[b]},add:function(a,b,c){if(void 0!==a._materialLib[b])throw Error("Material "+b+" already exists.");if(!c.isaMaterial)throw Error("Object for "+b+" isn't a material!");return a._materialLib[b]=
...
a},useMe:function(a){var b=TentaGL.ShaderLib.current(a);b.setMaterialProps&&b.setMaterialProps(a,this)}};TentaGL.RenderMode={};TentaGL.RenderMode.set3DOpaque=function(a){TentaGL.Blend.setEnabled(a,!1);TentaGL.DepthBuffer.setEnabled(a,!0);TentaGL.Cull.setMode(a,GL_NONE)};TentaGL.RenderMode.set3DTrans=function(a){TentaGL.Blend.setEnabled(a,!0);TentaGL.Blend.setEquation(a,GL_FUNC_ADD,GL_SRC_ALPHA,GL_ONE_MINUS_SRC_ALPHA);TentaGL.DepthBuffer.setEnabled(a,!1);TentaGL.Cull.setMode(a,GL_NONE)};
...
TentaGL.VBOData=function(a,b,c){var d=[];this._byteOffsets={};for(var e=b.getVertices(),f=0;f<e.length;f++){var g=e[f],k=0,m;for(m in c){var h=c[m],l=h.getValues(g);this._byteOffsets[m]=k;k+=h.sizeBytes();for(h=0;h<l.length;h++)d.push(l[h])}}this._attrBuffer=a.createBuffer();a.bindBuffer(GL_ARRAY_BUFFER,this._attrBuffer);a.bufferData(GL_ARRAY_BUFFER,new Float32Array(d),GL_STATIC_DRAW);d=b.getIndices();this._numIndices=b.numIndices();this._elemBuffer=a.createBuffer();a.bindBuffer(GL_ELEMENT_ARRAY_BUFFER,
...
TentaGL.VBORenderer={_mode:GL_TRIANGLES,getDrawMode:function(){return this._mode},setDrawMode:function(a){this._mode=a},render:function(a,b){var c=TentaGL.ShaderLib.current(a),d=b.getAttrBuffer(),e=b.getElemBuffer(),f=b.getStride();a.bindBuffer(GL_ARRAY_BUFFER,d);c=c.getAttributes();for(d=0;d<c.length;d++){var g=c[d],k=b.getOffset(g.getProfile());a.vertexAttribPointer(g.getLocation(),g.getSizeUnits(),g.getUnitType(),!1,f,k)}f=this._mode;b.getDrawMode()==GL_LINES&&(f=GL_LINES);TentaGL.Cull.setMode(a,
b.getCullMode());a.bindBuffer(GL_ELEMENT_ARRAY_BUFFER,e);a.drawElements(f,b.numIndices(),GL_UNSIGNED_SHORT,0)}};TentaGL.Renderable={};TentaGL.Renderable.prototype={isaRenderable:!0,render:function(a){}};
TentaGL.SceneNode=function(a){void 0===a&&(a=[0,0,0]);a[2]||(a[2]=0);this._xyz=vec4.fromValues(a[0],a[1],a[2],1);this._scaleXYZ=[1,1,1];this._scaleUni=1;this._quat=quat.create();this._objLook=vec3.fromValues(0,0,1);this._objUp=vec3.fromValues(0,1,0);this._transform=mat4.create();this._isVisible=this._tranDirty=!0;this._parent=void 0};
...
b=b.getCompositeParent();return a},isVisible:function(){return this._isVisible},setVisible:function(a){this._isVisible=a},getXYZ:function(){return this._xyz},getWorldXYZ:function(){var a=this.getWorldTransform();return vec4.fromValues(a[12],a[13],a[14],1)},setXYZ:function(a){this._xyz[0]=a[0];this._xyz[1]=a[1];this._xyz[2]=a[2];this._tranDirty=!0},getX:function(){return this._xyz[0]},getY:function(){return this._xyz[1]},getZ:function(){return this._xyz[2]},xyz:function(a){if(a)this.setXYZ(a);else return this.getXYZ()},
x:function(a){if(a)this._xyz[0]=a,this._tranDirty=!0;else return this._xyz[0]},y:function(a){if(a)this._xyz[1]=a,this._tranDirty=!0;else return this._xyz[1]},z:function(a){if(a)this._xyz[2]=a,this._tranDirty=!0;else return this._xyz[2]},getQuat:function(){return this._quat},getWorldQuat:function(){return this._getWorldQuat(quat.create())},_getWorldQuat:function(a){quat.mul(a,this.getQuat(),a);return this._parent?this._parent._getWorldQuat(a):a},setQuat:function(a){this._quat=a;this._tranDirty=!0},
getParentWorldQuat:function(){return this._parent?this._parent.getWorldQuat():quat.create()},rotate:function(a,b){var c=quat.setAxisAngle(quat.create(),a,b);this.setQuat(quat.mul(this._quat,c,this._quat))},mulQuat:function(a){this.setQuat(quat.mul(this._quat,a,this._quat))},getBaseLook:function(){return this._objLook},getWorldBaseLook:function(){var a=this.getParentWorldQuat();return vec3.transformQuat(vec3.create(),this._objLook,a)},setBaseLook:function(a){vec3.normalize(this._objLook,a);this._correctUpVector()},
getLook:function(){return vec3.transformQuat(vec3.create(),this._objLook,this._quat)},getWorldLook:function(){var a=this.getWorldQuat();return vec3.transformQuat(vec3.create(),this.getBaseLook(),a)},getBaseRight:function(){return vec3.cross(vec3.create(),this._objLook,this._objUp)},getWorldBaseRight:function(){var a=this.getParentWorldQuat();return vec3.transformQuat(vec3.create(),this.getBaseRight(),a)},getRight:function(){return vec3.transformQuat(vec3.create(),this.getBaseRight(),this._quat)},
getWorldRight:function(){var a=this.getWorldQuat();return vec3.transformQuat(vec3.create(),this.getBaseRight(),a)},getUp:function(){return vec3.transformQuat(vec3.create(),this._objUp,this._quat)},getWorldUp:function(){var a=this.getWorldQuat();return vec3.transformQuat(vec3.create(),this.getBaseUp(),a)},getBaseUp:function(){return this._objUp},getWorldBaseUp:function(){var a=this.getParentWorldQuat();return vec3.transformQuat(vec3.create(),this._objUp,a)},setBaseUp:function(a){vec3.normalize(this._objUp,
a);this._correctUpVector()},_correctUpVector:function(){var a=this._objLook,b=this._objUp,c=vec3.cross(vec3.create(),a,b);this._objUp=vec3.cross(b,c,a)},getBaseLookVectors:function(){return[this.getBaseLook(),this.getBaseUp(),this.getBaseRight()]},getLookVectors:function(){this.getQuat();var a=vec3.transformQuat(vec3.create(),this._objLook,this._quat),b=vec3.transformQuat(vec3.create(),this._objUp,this._quat),c=vec3.transformQuat(vec3.create(),this.getBaseRight,this._quat);return[a,b,c]},getWorldLookVectors:function(){this.getWorldQuat();
var a=vec3.transformQuat(vec3.create(),this._objLook,this._quat),b=vec3.transformQuat(vec3.create(),this._objUp,this._quat),c=vec3.transformQuat(vec3.create(),this.getBaseRight,this._quat);return[a,b,c]},orient:function(a,b){this.setQuat(TentaGL.Math.getOrientation(this.getBaseLook(),this.getBaseUp(),a,b))},orientWorld:function(a,b){var c=this.getParentWorldQuat();quat.invert(c,c);a=vec3.transformQuat(vec3.create(),a,c);b=vec3.transformQuat(vec3.create(),b,c);this.setQuat(TentaGL.Math.getOrientation(this.getBaseLook(),
this.getBaseUp(),a,b))},lookAt:function(a){var b=this.getXYZ();a=vec3.fromValues(a[0]-b[0],a[1]-b[1],a[2]-b[2]);b=vec3.cross(vec3.create(),a,this.getBaseUp());b=vec3.cross(vec3.create(),b,a);this.orient(a,b)},lookAtWorld:function(a){var b=this.getWorldXYZ();a=vec3.fromValues(a[0]-b[0],a[1]-b[1],a[2]-b[2]);b=vec3.cross(vec3.create(),a,this.getWorldBaseUp());b=vec3.cross(vec3.create(),b,a);this.orientWorld(a,b)},billboardPoint:function(a,b){var c=this.getXYZ(),c=vec3.fromValues(a[0]-c[0],a[1]-c[1],
a[2]-c[2]),d=vec3.cross(vec3.create(),c,b);b=vec3.cross(vec3.create(),d,c);this.orient(c,b)},billboardWorldPoint:function(a,b){var c=this.getWorldXYZ(),c=vec3.fromValues(a[0]-c[0],a[1]-c[1],a[2]-c[2]),d=vec3.cross(vec3.create(),c,b);b=vec3.cross(vec3.create(),d,c);this.orientWorld(c,b)},billboardAxis:function(a){var b=this.getXYZ(),c=this.getBaseLook(),d=this.getBaseUp();a=vec3.fromValues(a[0]-b[0],a[1]-b[1],a[2]-b[2]);var b=TentaGL.Math.getQuatFromTo(c,a),e=vec3.transformQuat(vec3.create(),d,b),
f=vec3.cross(vec3.create(),a,d),f=vec3.cross(vec3.create(),f,a),e=TentaGL.Math.getQuatFromTo(e,f);quat.mul(b,e,b);e=TentaGL.Math.getQuatFromTo(f,d);quat.mul(b,e,b);a=vec3.transformQuat(a,c,b);this.orient(a,d)},billboardWorldAxis:function(a){var b=this.getWorldXYZ(),c=this.getWorldBaseLook(),d=this.getWorldBaseUp();a=vec3.fromValues(a[0]-b[0],a[1]-b[1],a[2]-b[2]);var b=TentaGL.Math.getQuatFromTo(c,a),e=vec3.transformQuat(vec3.create(),d,b),f=vec3.cross(vec3.create(),a,d),f=vec3.cross(vec3.create(),
f,a),e=TentaGL.Math.getQuatFromTo(e,f);quat.mul(b,e,b);e=TentaGL.Math.getQuatFromTo(f,d);quat.mul(b,e,b);a=vec3.transformQuat(a,c,b);this.orientWorld(a,d)},billboardPlane:function(a,b){this.orient(a,b)},billboardWorldPlane:function(a,b){this.orientWorld(a,b)},getScaleXYZ:function(){return this._ScaleXYZ},setScaleXYZ:function(a){this._scaleXYZ=vec3.fromValues(a[0],a[1],a[2]);this._tranDirty=!0},getScaleX:function(){return this._scaleXYZ[0]},getScaleY:function(){return this._scaleXYZ[1]},getScaleZ:function(){return this._scaleXYZ[2]},
getScaleUni:function(){return this._scaleUni},setScaleUni:function(a){this._scaleUni=a;this._tranDirty=!0},getWorldScaleUni:function(){var a=this.getScaleUni();this._parent&&(a+=this._parent.getWorldScaleUni());return a},scale:function(a){if(a)this.setScaleXYZ(a);else return this.getScaleXYZ()},scaleX:function(a){if(a)this._scaleXYZ[0]=a,this._tranDirty=!0;else return this._scaleXYZ[0]},scaleY:function(a){if(a)this._scaleXYZ[1]=a,this._tranDirty=!0;else return this._scaleXYZ[1]},scaleZ:function(a){if(a)this._scaleXYZ[2]=
a,this._tranDirty=!0;else return this._scaleXYZ[2]},scaleU:function(a){if(a)this._scaleUni=a,this._tranDirty=!0;else return this._scaleUni},getModelTransform:function(){this._tranDirty&&(this._transform=this.getTRSTransform(),this._tranDirty=!1);return this._transform},getTRSTransform:function(){var a=this.getX(),b=this.getY(),c=this.getZ(),d=this.getScaleUni(),e=this.getScaleX()*d,f=this.getScaleY()*d,d=this.getScaleZ()*d,g=this._transform;mat4.fromQuat(g,this.getQuat());g[0]*=e;g[1]*=e;g[2]*=e;
g[4]*=f;g[5]*=f;g[6]*=f;g[8]*=d;g[9]*=d;g[10]*=d;g[12]=a;g[13]=b;g[14]=c;g[15]=1;return g},getWorldTransform:function(){return this._getWorldTransform(mat4.create())},_getWorldTransform:function(a){mat4.mul(a,this.getModelTransform(),a);this._parent&&this._parent._getWorldTransform(a);return a},render:function(a){this.isVisible()&&TentaGL.SceneNode.filter(this)&&(TentaGL.ViewTrans.push(a),TentaGL.ViewTrans.mul(a,this.getModelTransform()),this.draw(a),TentaGL.ViewTrans.pop(a))},draw:function(a){}};
...
TentaGL.ViewTrans.getCamera(a).getViewTransform();this._children.sort(function(a,d){var e=a.getWorldXYZ();vec3.transformMat4(e,e,b);var f=d.getWorldXYZ();vec3.transformMat4(f,f,b);return e[2]-f[2]});this.render(a)}},draw:function(a){for(var b=0;b<this.size();b++)this._children[b].render(a)}};Util.Inheritance.inherit(TentaGL.SceneGroup,TentaGL.SceneNode);TentaGL.Sprite=function(a){TentaGL.SceneNode.call(this,a);this._anchorXYZ=vec4.fromValues(0,0,0,1);this._pickEventListeners=[]};
TentaGL.Sprite.prototype={constructor:TentaGL.Sprite,isaSprite:!0,getAnchorXYZ:function(){return this._anchorXYZ},setAnchorXYZ:function(a){this._anchorXYZ=vec4.fromValues(a[0],a[1],a[2],1)},getAnchorX:function(){return this._anchorXYZ[0]},getAnchorY:function(){return this._anchorXYZ[1]},getAnchorZ:function(){return this._anchorXYZ[2]},anchor:function(a){if(a)this.setAnchorXYZ(a);else return this.getAnchorXYZ()},firePickEvent:function(a){a=new TentaGL.PickEvent(this,a);for(var b in this._pickEventListeners)this._pickEventListeners[b].handlePickEvent(a)},
addPickEventListener:function(a){this._pickEventListeners.push(a)},removePickEventListener:function(a){a=this._pickEventListeners.indexOf(node);if(-1==a)return!1;this._pickEventListeners.splice(a,1);return!0},getTRSTransform:function(){var a=this.getX(),b=this.getY(),c=this.getZ(),d=0-this.getAnchorX(),e=0-this.getAnchorY(),f=0-this.getAnchorZ(),g=this.getScaleUni(),k=this.getScaleX()*g,m=this.getScaleY()*g,g=this.getScaleZ()*g,h=this._transform;mat4.fromQuat(h,this.getQuat());h[0]*=k;h[1]*=k;h[2]*=
k;h[4]*=m;h[5]*=m;h[6]*=m;h[8]*=g;h[9]*=g;h[10]*=g;h[12]=d*h[0]+e*h[4]+f*h[8]+a;h[13]=d*h[1]+e*h[5]+f*h[9]+b;h[14]=d*h[2]+e*h[6]+f*h[10]+c;h[15]=1;return h},draw:function(a){}};Util.Inheritance.inherit(TentaGL.Sprite,TentaGL.SceneNode);TentaGL.Sprite.create=function(a,b,c,d,e){a=new TentaGL.Sprite(a);e||(e=new TentaGL.MaterialProps);a.draw=function(a){try{TentaGL.ShaderLib.use(a,d),TentaGL.MaterialLib.use(a,c),e.useMe(a),TentaGL.ModelLib.render(a,b)}catch(g){}};return a};
...
TentaGL.SceneNode.filter(this)){TentaGL.ViewTrans.push(a);this._updateAlignment();var b=TentaGL.ViewTrans.getCamera(a);b.getEye();this.billboardWorldPlane(vec3.negate(vec3.create(),b.getLook()),b.getUp());TentaGL.ViewTrans.mul(a,this.getModelTransform());this.draw(a);TentaGL.ViewTrans.pop(a)}},draw:function(a){}};Util.Inheritance.inherit(TentaGL.IconSprite,TentaGL.Sprite);TentaGL.ImageIconSprite=function(a,b){TentaGL.IconSprite.call(this,a);this._texName=b;this._texHeight=this._texWidth=1};
...
b,a._viewTrans)},setProjection:function(a,b){a._projTrans=b},getProjection:function(a){return a._projTrans},mulProjection:function(a,b){mat4.mul(a._projTrans,a._projTrans,b)},premulProjection:function(a,b){mat4.mul(a._projTrans,b,a._projTrans)},updateMVPUniforms:function(a){var b=TentaGL.ShaderLib.current(a);b.setNormalTrans&&(mat3.normalFromMat4(a._normalTrans,a._modelViewTrans),b.setNormalTrans(a,a._normalTrans));b.setMVPTrans&&(mat4.mul(a._mvpTrans,a._projTrans,a._modelViewTrans),b.setMVPTrans(a,
a._mvpTrans));b.setMVTrans&&b.setMVTrans(a,a._modelViewTrans);b.setVTrans&&b.setVTrans(a,a._viewTrans)},getCamera:function(a){return a._camera},setCamera:function(a,b,c){a._camera=b;this.set(a,b.getViewTransform());this.setView(a,b.getViewTransform());this.setProjection(a,b.getProjectionTransform(c))}};TentaGL.BlitteredFont=function(a,b,c,d,e,f){a&&this._createChars(a,b,c,d);void 0===e&&(e=1);void 0===f&&(f=1);this._hPad=e;this._vPad=f;this._texIDPrefix="bfont"+TentaGL.BlitteredFont._count+":";TentaGL.BlitteredFont._count++};
TentaGL.BlitteredFont._count=0;
TentaGL.BlitteredFont.prototype={constructor:TentaGL.BlitteredFont,isaBlitteredFont:!0,clean:function(a){for(var b in this._charPixData)TentaGL.MaterialLib.remove(a,this._texIDPrefix+b)},_createChars:function(a,b,c,d){this._charPixData={};this._charWidths={};this._monospaced=b;this._charW=c;this._charH=d;for(var e=32;128>e;e++){var f=Math.floor((e-32)/16),g=1+(e-32)%16*(c+2),k=a.getHeight()-(1+d+f*(2+d)),f=String.fromCharCode(e),g=a.crop(g,k,c,d);if(b||32==e)this._charWidths[f]=b||32!=e?c:c/2;else{for(var m=
0,h=g.getWidth()-1,l=!1;m<h&&!l;){for(k=0;k<g.getHeight();k++)if(0!=g.getPixelAt(m,k)[3]){l=!0;break}l||m++}for(l=!1;h>m&&!l;){for(k=0;k<g.getHeight();k++)if(0!=g.getPixelAt(h,k)[3]){l=!0;break}l||h--}k=h-m+1;g=g.crop(m,0,k,d);this._charWidths[f]=k}this._charPixData[f]=g;g.toCanvas()}},isMonospaced:function(){return this._monospaced},getLineHeight:function(){return this._charH},getCharPixelData:function(a){return this._charPixData[a]},getCharWidth:function(a){return this._charWidths[a]},getHorizontalPadding:function(){return this._hPad},
getVerticalPadding:function(){return this._vPad},_createTextures:function(a){for(var b in this._charPixData){var c=this._texIDPrefix+b,d=TentaGL.Texture.fromPixelData(a,this._charPixData[b]);TentaGL.MaterialLib.add(a,c,d)}},getStringDimensions:function(a,b){if(!this._charWidths)return[0,0];var c=0,d=0,e=this.getLineHeight(),f=this.getVerticalPadding(),g=this.getHorizontalPadding(),k=1;b&&(k=b/e);for(var m=a.split("\n"),h=0;h<m.length;h++){for(var l=m[h],p=0,n=0;n<l.length;n++)var r=l.charAt(n),r=
this.getCharWidth(r),p=p+(r+g);p>c&&(c=p);d+=e+f}return[c*k,d*k]},renderString:function(a,b,c,d,e){if(this._charPixData){TentaGL.MaterialLib.has(a,this._texIDPrefix+" ")||this._createTextures(a);var f=this.getLineHeight(),g=this.getVerticalPadding(),k=this.getHorizontalPadding();TentaGL.ViewTrans.push(a);TentaGL.ViewTrans.translate(a,c);e&&(c=e/f,TentaGL.ViewTrans.scale(a,[c,c]));b=b.split("\n");for(c=0;c<b.length;c++){e=b[c];TentaGL.ViewTrans.push(a);for(var m=0;m<e.length;m++){var h=e.charAt(m),
l=this._texIDPrefix+h,h=this.getCharWidth(h);TentaGL.MaterialLib.use(a,l);TentaGL.ViewTrans.push(a);TentaGL.ViewTrans.scale(a,[h,f]);TentaGL.ViewTrans.updateMVPUniforms(a);d?TentaGL.ModelLib.render(a,"unitSprite"):TentaGL.ModelLib.render(a,"unitPlane");TentaGL.ViewTrans.pop(a);TentaGL.ViewTrans.translate(a,[h+k,0])}TentaGL.ViewTrans.pop(a);d?TentaGL.ViewTrans.translate(a,[0,f+g]):TentaGL.ViewTrans.translate(a,[0,-(f+g)])}TentaGL.ViewTrans.pop(a)}}};
TentaGL.BlitteredFont.fromURL=function(a,b,c,d,e,f,g){var k=new TentaGL.BlitteredFont(void 0,b,c,d,e,f);TentaGL.PixelData.fromURL(a,function(a){g&&(a=g(a));k._createChars(a,b,c,d)});return k};
TentaGL.BlitteredFont.fromFont=function(a,b,c,d,e){var f="monospace"==a.getType(),g=a.getStringDimensions("W"),k=Math.floor(g[0]),g=Math.floor(g[1]);c=new TentaGL.BlitteredFont(void 0,f,k,g,c,d);d=1.5<b.getRed()+b.getGreen()+b.getBlue()?new TentaGL.Color.RGBA(0,0,0,1):new TentaGL.Color.RGBA(1,1,1,1);for(var m=TentaGL.Canvas2D.create(16*(k+2),6*(g+2),d),h=32;128>h;h++){var l=1+(h-32)%16*(k+2),p=1+Math.floor((h-32)/16)*(g+2),n=String.fromCharCode(h),r=TentaGL.Canvas2D.create(k,g,d);TentaGL.Canvas2D.drawString(r,
n,a,b,0,0);TentaGL.Canvas2D.drawImage(m,r,l,p)}a=TentaGL.PixelData.fromCanvas(m);a=a.filter(new TentaGL.RGBAFilter.OneColor(b,.5));e&&(a=e(a));c._createChars(a,f,k,g);return c};TentaGL.Font=function(a,b,c){this._name=a;this._type=b;this._size=c;this._italic=this._bold=!1;this._vPad=1};
...
TentaGL.DefaultShader=function(a){var b=TentaGL.ShaderLib.getDefaultShaderPath(a),b=TentaGL.ShaderProgram.srcFromURL(a,b+"default.vert",b+"default.frag");console.log("\nCreating DefaultShader");TentaGL.ShaderProgram.call(this,a,b[0],b[1]);this.setAttrGetter("vertexPos",TentaGL.Vertex.prototype.getXYZ)};TentaGL.DefaultShader.SHADER_ID="_default";TentaGL.DefaultShader.prototype={constructor:TentaGL.DefaultShader,isaDefaultShader:!0};
...
TentaGL.LinearGradientShader=function(a){var b=TentaGL.ShaderLib.getDefaultShaderPath(a),b=TentaGL.ShaderProgram.srcFromURL(a,b+"gradientLinear.vert",b+"gradientLinear.frag");console.log("\nCreating linear gradient shader");TentaGL.ShaderProgram.call(this,a,b[0],b[1]);this.setAttrGetter("vertexPos",TentaGL.Vertex.prototype.getXYZ);this.setAttrGetter("vertexNormal",TentaGL.Vertex.prototype.getNormal);this.setAttrGetter("vertexTexCoords",TentaGL.Vertex.prototype.getTexST);this._mvpUni=this.getUniform("mvpTrans");
this._normalUni=this.getUniform("normalTrans");this._startPtUni=this.getUniform("p");this._gradVectorUni=this.getUniform("u");this._colorsUni=this.getUniform("colors[0]");this._breakPtsUni=this.getUniform("breakPts[0]");this._breakPtCountUni=this.getUniform("breakPtCount")};
...
TentaGL.NormalShader=function(a){var b=TentaGL.ShaderLib.getDefaultShaderPath(a),b=TentaGL.ShaderProgram.srcFromURL(a,b+"normal.vert",b+"normal.frag");TentaGL.ShaderProgram.call(this,a,b[0],b[1]);this.setAttrGetter("vertexPos",TentaGL.Vertex.prototype.getXYZ);this.setAttrGetter("vertexNormal",TentaGL.Vertex.prototype.getNormal);this.setAttrGetter("vertexTexCoords",TentaGL.Vertex.prototype.getTexST);this._mvpUni=this.getUniform("mvpTrans");this._normalUni=this.getUniform("normalTrans");this._texUni=
this.getUniform("tex");this._useTexUni=this.getUniform("useTex")};TentaGL.NormalShader.prototype={constructor:TentaGL.NormalShader,isaSimpleShader:!0,setMVPTrans:function(a,b){this._mvpUni.set(a,b)},setNormalTrans:function(a,b){this._normalUni.set(a,b)},setColor:function(a,b){this._useTexUni.set(a,[0])},setTex:function(a,b){this._texUni.set(a,[b]);this._useTexUni.set(a,[1])}};TentaGL.NormalShader.load=function(a,b){var c=new TentaGL.NormalShader(a);TentaGL.ShaderLib.add(a,b,c);return c};
Util.Inheritance.inherit(TentaGL.NormalShader,TentaGL.ShaderProgram);
TentaGL.PerVertexPhongShader=function(a){var b=TentaGL.ShaderLib.getDefaultShaderPath(a),b=TentaGL.ShaderProgram.srcFromURL(a,b+"phongPerVertex.vert",b+"phongPerVertex.frag");console.log("\nCreating PerVertexPhongShader");TentaGL.ShaderProgram.call(this,a,b[0],b[1]);this.setAttrGetter("vertexPos",TentaGL.Vertex.prototype.getXYZ);this.setAttrGetter("vertexNormal",TentaGL.Vertex.prototype.getNormal);this.setAttrGetter("vertexTexCoords",TentaGL.Vertex.prototype.getTexST);this.setAttrGetter("vertexTang",
TentaGL.Vertex.prototype.getTangental);this._mvpUni=this.getUniform("mvpTrans");this._mvUni=this.getUniform("mvTrans");this._vUni=this.getUniform("vTrans");this._normalUni=this.getUniform("normalTrans");this._colorUni=this.getUniform("solidColor");this._texUni=this.getUniform("tex");this._useTexUni=this.getUniform("useTex");this._materialUni={};this._materialUni.diff=this.getUniform("m.diff");this._materialUni.spec=this.getUniform("m.spec");this._materialUni.amb=this.getUniform("m.amb");this._materialUni.emis=
this.getUniform("m.emis");this._materialUni.shininess=this.getUniform("m.shininess");this._lightsUni=[];for(a=0;a<TentaGL.PerVertexPhongShader.MAX_LIGHTS;a++){var b=this._lightsUni[a]={},c="lights["+a+"]";b.type=this.getUniform(c+".type");b.pos=this.getUniform(c+".pos");b.dir=this.getUniform(c+".dir");b.diff=this.getUniform(c+".diff");b.spec=this.getUniform(c+".spec");b.amb=this.getUniform(c+".amb");b.attenA=this.getUniform(c+".attenA");b.attenB=this.getUniform(c+".attenB");b.attenC=this.getUniform(c+
".attenC");b.cutOffAngleCos=this.getUniform(c+".cutOffAngleCos");b.spotExp=this.getUniform(c+".spotExp")}this._numLightsUni=this.getUniform("numLights")};TentaGL.PerVertexPhongShader.MAX_LIGHTS=16;TentaGL.PerVertexPhongShader.LIGHT_AMB=1;TentaGL.PerVertexPhongShader.LIGHT_PT=2;TentaGL.PerVertexPhongShader.LIGHT_DIR=3;TentaGL.PerVertexPhongShader.LIGHT_SPOT=4;
TentaGL.PerVertexPhongShader.prototype={constructor:TentaGL.PerVertexPhongShader,isaPerVertexPhongShader:!0,setMVPTrans:function(a,b){this._mvpUni.set(a,b)},setMVTrans:function(a,b){this._mvUni.set(a,b)},setVTrans:function(a,b){this._vUni.set(a,b)},setNormalTrans:function(a,b){this._normalUni.set(a,b)},setColor:function(a,b){this._colorUni.set(a,b);this._useTexUni.set(a,[0])},setTex:function(a,b){this._texUni.set(a,[b]);this._useTexUni.set(a,[1])},setMaterialProps:function(a,b){this._materialUni.diff.set(a,
b.getDiffuse().getRGBA());this._materialUni.spec.set(a,b.getSpecular().getRGBA());this._materialUni.amb.set(a,b.getAmbient().getRGBA());this._materialUni.emis.set(a,b.getEmission().getRGBA());this._materialUni.shininess.set(a,[b.getShininess()])},setLights:function(a,b){var c=Math.min(b.length,TentaGL.PerVertexPhongShader.MAX_LIGHTS);this._numLightsUni.set(a,[b.length]);for(var d=0;d<c;d++){var e=b[d],f=this._lightsUni[d];e.isaAmbientLight&&f.type.set(a,[TentaGL.PerVertexPhongShader.LIGHT_AMB]);e.isaPointLight&&
f.type.set(a,[TentaGL.PerVertexPhongShader.LIGHT_PT]);e.isaDirectionalLight&&f.type.set(a,[TentaGL.PerVertexPhongShader.LIGHT_DIR]);e.isaSpotLight&&f.type.set(a,[TentaGL.PerVertexPhongShader.LIGHT_SPOT]);e.isaPointLight?f.pos.set(a,e.getXYZ()):f.pos.set(a,[0,0,0,0]);e.isaDirectionalLight?f.dir.set(a,e.getDirection()):f.dir.set(a,[0,0,0]);f.diff.set(a,e.getDiffuse().getRGBA());f.spec.set(a,e.getSpecular().getRGBA());f.amb.set(a,e.getAmbient().getRGBA());if(e.isaPointLight){var g=e.getAttenuation();
f.attenA.set(a,[g[0]]);f.attenB.set(a,[g[1]]);f.attenC.set(a,[g[2]])}else f.attenA.set(a,[0]),f.attenB.set(a,[0]),f.attenC.set(a,[0]);e.isaSpotLight?(f.cutOffAngleCos.set(a,[Math.cos(e.getCutOffAngle())]),f.spotExp.set(a,[e.getSpotExponent()])):(f.cutOffAngleCos.set(a,[0]),f.spotExp.set(a,[0]))}for(d=c;d<TentaGL.PerVertexPhongShader.MAX_LIGHTS;d++)f=this._lightsUni[d],f.type.set(a,[0]),f.pos.set(a,[0,0,0,0]),f.dir.set(a,[0,0,0]),f.diff.set(a,[0,0,0,0]),f.spec.set(a,[0,0,0,0]),f.amb.set(a,[0,0,0,0]),
f.attenA.set(a,[0]),f.attenB.set(a,[0]),f.attenC.set(a,[0]),f.cutOffAngleCos.set(a,[0]),f.spotExp.set(a,[0])}};TentaGL.PerVertexPhongShader.load=function(a,b){var c=new TentaGL.PerVertexPhongShader(a);TentaGL.ShaderLib.add(a,b,c);return c};Util.Inheritance.inherit(TentaGL.PerVertexPhongShader,TentaGL.ShaderProgram);
TentaGL.PerVertexPhongShaderMac=function(a){var b=TentaGL.ShaderLib.getDefaultShaderPath(a),b=TentaGL.ShaderProgram.srcFromURL(a,b+"phongPerVertexMac.vert",b+"phongPerVertexMac.frag");console.log("\nCreating PerVertexPhongShaderMac");TentaGL.ShaderProgram.call(this,a,b[0],b[1]);this.setAttrGetter("vertexPos",TentaGL.Vertex.prototype.getXYZ);this.setAttrGetter("vertexNormal",TentaGL.Vertex.prototype.getNormal);this.setAttrGetter("vertexTexCoords",TentaGL.Vertex.prototype.getTexST);this.setAttrGetter("vertexTang",
TentaGL.Vertex.prototype.getTangental);this._mvpUni=this.getUniform("mvpTrans");this._mvUni=this.getUniform("mvTrans");this._vUni=this.getUniform("vTrans");this._normalUni=this.getUniform("normalTrans");this._colorUni=this.getUniform("solidColor");this._texUni=this.getUniform("tex");this._useTexUni=this.getUniform("useTex");this._materialUni={};this._materialUni.diff=this.getUniform("m.diff");this._materialUni.spec=this.getUniform("m.spec");this._materialUni.amb=this.getUniform("m.amb");this._materialUni.emis=
this.getUniform("m.emis");this._materialUni.shininess=this.getUniform("m.shininess");this._lightUni={};this._lightUni.type=this.getUniform("light.type");this._lightUni.pos=this.getUniform("light.pos");this._lightUni.dir=this.getUniform("light.dir");this._lightUni.diff=this.getUniform("light.diff");this._lightUni.spec=this.getUniform("light.spec");this._lightUni.amb=this.getUniform("light.amb");this._lightUni.attenA=this.getUniform("light.attenA");this._lightUni.attenB=this.getUniform("light.attenB");
this._lightUni.attenC=this.getUniform("light.attenC");this._lightUni.cutOffAngleCos=this.getUniform("light.cutOffAngleCos");this._lightUni.spotExp=this.getUniform("light.spotExp")};TentaGL.PerVertexPhongShaderMac.LIGHT_AMB=1;TentaGL.PerVertexPhongShaderMac.LIGHT_PT=2;TentaGL.PerVertexPhongShaderMac.LIGHT_DIR=3;TentaGL.PerVertexPhongShaderMac.LIGHT_SPOT=4;
TentaGL.PerVertexPhongShaderMac.prototype={constructor:TentaGL.PerVertexPhongShader,isaPerVertexPhongShaderMac:!0,setMVPTrans:function(a,b){this._mvpUni.set(a,b)},setMVTrans:function(a,b){this._mvUni.set(a,b)},setVTrans:function(a,b){this._vUni.set(a,b)},setNormalTrans:function(a,b){this._normalUni.set(a,b)},setColor:function(a,b){this._colorUni.set(a,b);this._useTexUni.set(a,[0])},setTex:function(a,b){this._texUni.set(a,[b]);this._useTexUni.set(a,[1])},setMaterialProps:function(a,b){this._materialUni.diff.set(a,
b.getDiffuse().getRGBA());this._materialUni.spec.set(a,b.getSpecular().getRGBA());this._materialUni.amb.set(a,b.getAmbient().getRGBA());this._materialUni.emis.set(a,b.getEmission().getRGBA());this._materialUni.shininess.set(a,[b.getShininess()])},setLights:function(a,b){var c=b[0];c.isaAmbientLight&&this._lightUni.type.set(a,[TentaGL.PerVertexPhongShader.LIGHT_AMB]);c.isaPointLight&&this._lightUni.type.set(a,[TentaGL.PerVertexPhongShader.LIGHT_PT]);c.isaDirectionalLight&&this._lightUni.type.set(a,
[TentaGL.PerVertexPhongShader.LIGHT_DIR]);c.isaSpotLight&&this._lightUni.type.set(a,[TentaGL.PerVertexPhongShader.LIGHT_SPOT]);c.isaPointLight?this._lightUni.pos.set(a,c.getXYZ()):this._lightUni.pos.set(a,[0,0,0,0]);c.isaDirectionalLight?this._lightUni.dir.set(a,c.getDirection()):this._lightUni.dir.set(a,[0,0,0]);this._lightUni.diff.set(a,c.getDiffuse().getRGBA());this._lightUni.spec.set(a,c.getSpecular().getRGBA());this._lightUni.amb.set(a,c.getAmbient().getRGBA());if(c.isaPointLight){var d=c.getAttenuation();
this._lightUni.attenA.set(a,[d[0]]);this._lightUni.attenB.set(a,[d[1]]);this._lightUni.attenC.set(a,[d[2]])}else this._lightUni.attenA.set(a,[0]),this._lightUni.attenB.set(a,[0]),this._lightUni.attenC.set(a,[0]);c.isaSpotLight?(this._lightUni.cutOffAngleCos.set(a,[Math.cos(c.getCutOffAngle())]),this._lightUni.spotExp.set(a,[c.getSpotExponent()])):(this._lightUni.cutOffAngleCos.set(a,[0]),this._lightUni.spotExp.set(a,[0]))}};
...
TentaGL.PhongShader=function(a){var b=TentaGL.ShaderLib.getDefaultShaderPath(a),b=TentaGL.ShaderProgram.srcFromURL(a,b+"phong.vert",b+"phong.frag");console.log("\nCreating PhongShader");TentaGL.ShaderProgram.call(this,a,b[0],b[1]);this.setAttrGetter("vertexPos",TentaGL.Vertex.prototype.getXYZ);this.setAttrGetter("vertexNormal",TentaGL.Vertex.prototype.getNormal);this.setAttrGetter("vertexTexCoords",TentaGL.Vertex.prototype.getTexST);this.setAttrGetter("vertexTang",TentaGL.Vertex.prototype.getTangental);
this._mvpUni=this.getUniform("mvpTrans");this._mvUni=this.getUniform("mvTrans");this._vUni=this.getUniform("vTrans");this._normalUni=this.getUniform("normalTrans");this._colorUni=this.getUniform("solidColor");this._texUni=this.getUniform("tex");this._useTexUni=this.getUniform("useTex");this._bumpTexUni=this.getUniform("bumpTex");this._useBumpUni=this.getUniform("useBumpTex");this._materialUni={};this._materialUni.diff=this.getUniform("m.diff");this._materialUni.spec=this.getUniform("m.spec");this._materialUni.amb=
this.getUniform("m.amb");this._materialUni.emis=this.getUniform("m.emis");this._materialUni.shininess=this.getUniform("m.shininess");this._lightsUni=[];for(a=0;a<TentaGL.PhongShader.MAX_LIGHTS;a++){var b=this._lightsUni[a]={},c="lights["+a+"]";b.type=this.getUniform(c+".type");b.pos=this.getUniform(c+".pos");b.dir=this.getUniform(c+".dir");b.diff=this.getUniform(c+".diff");b.spec=this.getUniform(c+".spec");b.amb=this.getUniform(c+".amb");b.attenA=this.getUniform(c+".attenA");b.attenB=this.getUniform(c+
".attenB");b.attenC=this.getUniform(c+".attenC");b.cutOffAngleCos=this.getUniform(c+".cutOffAngleCos");b.spotExp=this.getUniform(c+".spotExp")}this._numLightsUni=this.getUniform("numLights")};TentaGL.PhongShader.MAX_LIGHTS=16;TentaGL.PhongShader.LIGHT_AMB=1;TentaGL.PhongShader.LIGHT_PT=2;TentaGL.PhongShader.LIGHT_DIR=3;TentaGL.PhongShader.LIGHT_SPOT=4;
TentaGL.PhongShader.prototype={constructor:TentaGL.PhongShader,isaPhongShader:!0,setMVPTrans:function(a,b){this._mvpUni.set(a,b)},setMVTrans:function(a,b){this._mvUni.set(a,b)},setVTrans:function(a,b){this._vUni.set(a,b)},setNormalTrans:function(a,b){this._normalUni.set(a,b)},setColor:function(a,b){this._colorUni.set(a,b);this._useTexUni.set(a,[0]);this._useBumpUni.set(a,[0])},setTex:function(a,b){this._texUni.set(a,[b]);this._useTexUni.set(a,[1]);this._useBumpUni.set(a,[0])},setBump:function(a,b){this._bumpTexUni.set(a,
[b]);this._useBumpUni.set(a,[1])},setMaterialProps:function(a,b){this._materialUni.diff.set(a,b.getDiffuse().getRGBA());this._materialUni.spec.set(a,b.getSpecular().getRGBA());this._materialUni.amb.set(a,b.getAmbient().getRGBA());this._materialUni.emis.set(a,b.getEmission().getRGBA());this._materialUni.shininess.set(a,[b.getShininess()])},setLights:function(a,b){var c=Math.min(b.length,TentaGL.PhongShader.MAX_LIGHTS);this._numLightsUni.set(a,[b.length]);for(var d=0;d<c;d++){var e=b[d],f=this._lightsUni[d];
e.isaAmbientLight&&f.type.set(a,[TentaGL.PhongShader.LIGHT_AMB]);e.isaPointLight&&f.type.set(a,[TentaGL.PhongShader.LIGHT_PT]);e.isaDirectionalLight&&f.type.set(a,[TentaGL.PhongShader.LIGHT_DIR]);e.isaSpotLight&&f.type.set(a,[TentaGL.PhongShader.LIGHT_SPOT]);e.isaPointLight?f.pos.set(a,e.getXYZ()):f.pos.set(a,[0,0,0,0]);e.isaDirectionalLight?f.dir.set(a,e.getDirection()):f.dir.set(a,[0,0,0]);f.diff.set(a,e.getDiffuse().getRGBA());f.spec.set(a,e.getSpecular().getRGBA());f.amb.set(a,e.getAmbient().getRGBA());
if(e.isaPointLight){var g=e.getAttenuation();f.attenA.set(a,[g[0]]);f.attenB.set(a,[g[1]]);f.attenC.set(a,[g[2]])}else f.attenA.set(a,[0]),f.attenB.set(a,[0]),f.attenC.set(a,[0]);e.isaSpotLight?(f.cutOffAngleCos.set(a,[Math.cos(e.getCutOffAngle())]),f.spotExp.set(a,[e.getSpotExponent()])):(f.cutOffAngleCos.set(a,[0]),f.spotExp.set(a,[0]))}for(d=c;d<TentaGL.PhongShader.MAX_LIGHTS;d++)f=this._lightsUni[d],f.type.set(a,[0]),f.pos.set(a,[0,0,0,0]),f.dir.set(a,[0,0,0]),f.diff.set(a,[0,0,0,0]),f.spec.set(a,
[0,0,0,0]),f.amb.set(a,[0,0,0,0]),f.attenA.set(a,[0]),f.attenB.set(a,[0]),f.attenC.set(a,[0]),f.cutOffAngleCos.set(a,[0]),f.spotExp.set(a,[0])}};TentaGL.PhongShader.load=function(a,b){var c=new TentaGL.PhongShader(a);TentaGL.ShaderLib.add(a,b,c);return c};Util.Inheritance.inherit(TentaGL.PhongShader,TentaGL.ShaderProgram);
TentaGL.PhongShaderMac=function(a){var b=TentaGL.ShaderLib.getDefaultShaderPath(a),b=TentaGL.ShaderProgram.srcFromURL(a,b+"phongMac.vert",b+"phongMac.frag");console.log("\nCreating PhongShaderMac");TentaGL.ShaderProgram.call(this,a,b[0],b[1]);this.setAttrGetter("vertexPos",TentaGL.Vertex.prototype.getXYZ);this.setAttrGetter("vertexNormal",TentaGL.Vertex.prototype.getNormal);this.setAttrGetter("vertexTexCoords",TentaGL.Vertex.prototype.getTexST);this.setAttrGetter("vertexTang",TentaGL.Vertex.prototype.getTangental);
this._mvpUni=this.getUniform("mvpTrans");this._mvUni=this.getUniform("mvTrans");this._vUni=this.getUniform("vTrans");this._normalUni=this.getUniform("normalTrans");this._colorUni=this.getUniform("solidColor");this._texUni=this.getUniform("tex");this._useTexUni=this.getUniform("useTex");this._bumpTexUni=this.getUniform("bumpTex");this._useBumpUni=this.getUniform("useBumpTex");this._materialUni={};this._materialUni.diff=this.getUniform("m.diff");this._materialUni.spec=this.getUniform("m.spec");this._materialUni.amb=
this.getUniform("m.amb");this._materialUni.emis=this.getUniform("m.emis");this._materialUni.shininess=this.getUniform("m.shininess");this._lightUni={};this._lightUni.type=this.getUniform("light.type");this._lightUni.pos=this.getUniform("light.pos");this._lightUni.dir=this.getUniform("light.dir");this._lightUni.diff=this.getUniform("light.diff");this._lightUni.spec=this.getUniform("light.spec");this._lightUni.amb=this.getUniform("light.amb");this._lightUni.attenA=this.getUniform("light.attenA");this._lightUni.attenB=
this.getUniform("light.attenB");this._lightUni.attenC=this.getUniform("light.attenC");this._lightUni.cutOffAngleCos=this.getUniform("light.cutOffAngleCos");this._lightUni.spotExp=this.getUniform("light.spotExp")};TentaGL.PhongShaderMac.LIGHT_AMB=1;TentaGL.PhongShaderMac.LIGHT_PT=2;TentaGL.PhongShaderMac.LIGHT_DIR=3;TentaGL.PhongShaderMac.LIGHT_SPOT=4;
TentaGL.PhongShaderMac.prototype={constructor:TentaGL.PhongShaderMac,isaPhongShaderMac:!0,setMVPTrans:function(a,b){this._mvpUni.set(a,b)},setMVTrans:function(a,b){this._mvUni.set(a,b)},setVTrans:function(a,b){this._vUni.set(a,b)},setNormalTrans:function(a,b){this._normalUni.set(a,b)},setColor:function(a,b){this._colorUni.set(a,b);this._useTexUni.set(a,[0]);this._useBumpUni.set(a,[0])},setTex:function(a,b){this._texUni.set(a,[b]);this._useTexUni.set(a,[1]);this._useBumpUni.set(a,[0])},setBump:function(a,
b){this._bumpTexUni.set(a,[b]);this._useBumpUni.set(a,[1])},setMaterialProps:function(a,b){this._materialUni.diff.set(a,b.getDiffuse().getRGBA());this._materialUni.spec.set(a,b.getSpecular().getRGBA());this._materialUni.amb.set(a,b.getAmbient().getRGBA());this._materialUni.emis.set(a,b.getEmission().getRGBA());this._materialUni.shininess.set(a,[b.getShininess()])},setLights:function(a,b){var c=b[0];c.isaAmbientLight&&this._lightUni.type.set(a,[TentaGL.PhongShaderMac.LIGHT_AMB]);c.isaPointLight&&this._lightUni.type.set(a,
[TentaGL.PhongShaderMac.LIGHT_PT]);c.isaDirectionalLight&&this._lightUni.type.set(a,[TentaGL.PhongShaderMac.LIGHT_DIR]);c.isaSpotLight&&this._lightUni.type.set(a,[TentaGL.PhongShaderMac.LIGHT_SPOT]);c.isaPointLight?this._lightUni.pos.set(a,c.getXYZ()):this._lightUni.pos.set(a,[0,0,0,0]);c.isaDirectionalLight?this._lightUni.dir.set(a,c.getDirection()):this._lightUni.dir.set(a,[0,0,0]);this._lightUni.diff.set(a,c.getDiffuse().getRGBA());this._lightUni.spec.set(a,c.getSpecular().getRGBA());this._lightUni.amb.set(a,
c.getAmbient().getRGBA());if(c.isaPointLight){var d=c.getAttenuation();this._lightUni.attenA.set(a,[d[0]]);this._lightUni.attenB.set(a,[d[1]]);this._lightUni.attenC.set(a,[d[2]])}else this._lightUni.attenA.set(a,[0]),this._lightUni.attenB.set(a,[0]),this._lightUni.attenC.set(a,[0]);c.isaSpotLight?(this._lightUni.cutOffAngleCos.set(a,[Math.cos(c.getCutOffAngle())]),this._lightUni.spotExp.set(a,[c.getSpotExponent()])):(this._lightUni.cutOffAngleCos.set(a,[0]),this._lightUni.spotExp.set(a,[0]))}};
TentaGL.PhongShaderMac.load=function(a,b){var c=new TentaGL.PhongShaderMac(a);TentaGL.ShaderLib.add(a,b,c);return c};Util.Inheritance.inherit(TentaGL.PhongShaderMac,TentaGL.ShaderProgram);
TentaGL.PickShader=function(a){var b=TentaGL.ShaderLib.getDefaultShaderPath(a),b=TentaGL.ShaderProgram.srcFromURL(a,b+"picker.vert",b+"picker.frag");TentaGL.ShaderProgram.call(this,a,b[0],b[1]);this.setAttrGetter("vertexPos",TentaGL.Vertex.prototype.getXYZ);this.setAttrGetter("vertexTexCoords",TentaGL.Vertex.prototype.getTexST);this._mvpUni=this.getUniform("mvpTrans");this._texUni=this.getUniform("tex");this._pickIDUni=this.getUniform("pickID")};
...
TentaGL.RadialGradientShader=function(a){var b=TentaGL.ShaderLib.getDefaultShaderPath(a),b=TentaGL.ShaderProgram.srcFromURL(a,b+"gradientRadial.vert",b+"gradientRadial.frag");console.log("\nCreating linear gradient shader");TentaGL.ShaderProgram.call(this,a,b[0],b[1]);this.setAttrGetter("vertexPos",TentaGL.Vertex.prototype.getXYZ);this.setAttrGetter("vertexNormal",TentaGL.Vertex.prototype.getNormal);this.setAttrGetter("vertexTexCoords",TentaGL.Vertex.prototype.getTexST);this._mvpUni=this.getUniform("mvpTrans");
this._normalUni=this.getUniform("normalTrans");this._startPtUni=this.getUniform("p");this._gradVectorUni=this.getUniform("u");this._colorsUni=this.getUniform("colors[0]");this._breakPtsUni=this.getUniform("breakPts[0]");this._breakPtCountUni=this.getUniform("breakPtCount")};
...
TentaGL.SimpleShader=function(a){var b=TentaGL.ShaderLib.getDefaultShaderPath(a),b=TentaGL.ShaderProgram.srcFromURL(a,b+"simple.vert",b+"simple.frag");console.log("\nCreating SimpleShader");TentaGL.ShaderProgram.call(this,a,b[0],b[1]);this.setAttrGetter("vertexPos",TentaGL.Vertex.prototype.getXYZ);this.setAttrGetter("vertexNormal",TentaGL.Vertex.prototype.getNormal);this.setAttrGetter("vertexTexCoords",TentaGL.Vertex.prototype.getTexST);this._mvpUni=this.getUniform("mvpTrans");this._normalUni=this.getUniform("normalTrans");
this._colorUni=this.getUniform("solidColor");this._texUni=this.getUniform("tex");this._useTexUni=this.getUniform("useTex")};TentaGL.SimpleShader.prototype={constructor:TentaGL.SimpleShader,isaSimpleShader:!0,setMVPTrans:function(a,b){this._mvpUni.set(a,b)},setNormalTrans:function(a,b){this._normalUni.set(a,b)},setColor:function(a,b){this._colorUni.set(a,b);this._useTexUni.set(a,[0])},setTex:function(a,b){this._texUni.set(a,[b]);this._useTexUni.set(a,[1])}};
TentaGL.SimpleShader.load=function(a,b){var c=new TentaGL.SimpleShader(a);TentaGL.ShaderLib.add(a,b,c);return c};Util.Inheritance.inherit(TentaGL.SimpleShader,TentaGL.ShaderProgram);TentaGL.Align={CENTER:1,LEFT:2,RIGHT:3,TOP:4,BOTTOM:5,FRONT:6,BACK:7};
...
for(var k in b)d=b[k],g.translate(0,c.getSize()),g.fillText(d,e,f),g.translate(0,c.getVerticalPadding());g.restore();return a},createString:function(a,b,c){var d=b.getStringDimensions(a),e=this.create(d[0],d[1]),f=e.getContext("2d");1==c.getRed()&&1==c.getGreen()&&1==c.getBlue()?f.fillStyle="black":f.fillStyle="white";f.fillRect(0,0,d[0],d[1]);this.drawString(e,a,b,c,0,0);return e},drawCircle:function(a,b,c,d,e,f,g){var k=a.getContext("2d");k.save();k.beginPath();k.arc(b,c,d,0,TentaGL.TAU);g&&(k.fillStyle=
g.toCSS(),k.fill());e&&(k.strokeStyle=e.toCSS(),k.lineWidth=f,k.stroke());k.restore();return a},createCircle:function(a,b,c,d){var e=2*a+c,e=this.create(e,e);this.drawCircle(e,a+c/2,a+c/2,a,b,c,d);return e},drawRect:function(a,b,c,d,e,f,g,k){var m=a.getContext("2d");m.save();k&&(m.fillStyle=k.toCSS(),m.fillRect(b,c,d,e));f&&(m.strokeStyle=f.toCSS(),m.lineWidth=g,m.strokeRect(b,c,d,e));m.restore();return a},createRect:function(a,b,c,d,e){var f=this.create(a+d,b+d);this.drawRect(f,d/2,d/2,a,b,c,d,e);
return f},drawRoundedRect:function(a,b,c,d,e,f,g,k,m){var h=a.getContext("2d");h.save();h.beginPath();h.moveTo(b+f,c);h.lineTo(b+d-f,c);h.arc(b+d-f,c+f,f,3*TentaGL.TAU/4,0);h.lineTo(b+d,c+e-f);h.arc(b+d-f,c+e-f,f,0,1*TentaGL.TAU/4);h.lineTo(b+f,c+e);h.arc(b+f,c+e-f,f,1*TentaGL.TAU/4,2*TentaGL.TAU/4);h.lineTo(b,c+f);h.arc(b+f,c+f,f,2*TentaGL.TAU/4,3*TentaGL.TAU/4);m&&(h.fillStyle=m.toCSS(),h.fill());g&&(h.strokeStyle=g.toCSS(),h.lineWidth=k,h.stroke());h.restore();return a},createRoundedRect:function(a,
