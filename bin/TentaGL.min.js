...
b,c);a.bindRenderbuffer(GL_RENDERBUFFER,null);return d}};TentaGL.RenderMode={};TentaGL.RenderMode.set3DOpaque=function(a){TentaGL.Blend.setEnabled(a,!1);TentaGL.DepthBuffer.setEnabled(a,!0);TentaGL.DepthBuffer.setMaskEnabled(a,!0);TentaGL.Cull.setMode(a,GL_NONE)};
...
b.getCullMode());a.bindBuffer(GL_ELEMENT_ARRAY_BUFFER,e);a.drawElements(f,b.numIndices(),GL_UNSIGNED_SHORT,0)}};TentaGL.Vertex=function(a,b,c){this._xyz=vec4.fromValues(a,b,c,1);this._texST=vec2.fromValues(0,0);this._normal=vec3.fromValues(0,0,0);this._tangental=vec3.fromValues(0,0,0)};
...
a},useMe:function(a){var b=TentaGL.ShaderLib.current(a);b.setMaterialProps&&b.setMaterialProps(a,this)}};TentaGL.Renderable={};TentaGL.Renderable.prototype={isaRenderable:!0,render:function(a){}};
