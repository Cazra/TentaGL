...
a[2]*=a[3];return[c,a]},getViewVolumeCorners:function(a,b){var c=this.projectToClip([0,b],a,b),d=this.projectToClip([a,b],a,b),e=this.projectToClip([a,0],a,b),f=this.projectToClip([0,0],a,b);return[c[0],d[0],e[0],f[0],c[1],d[1],e[1],f[1]]}};Util.Inheritance.inherit(TentaGL.Camera3D,TentaGL.Camera);
