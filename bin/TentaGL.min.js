...
getCanvas:function(){return this._canvas},getGL:function(){return this._gl},getPicker:function(){return this._picker},getWidth:function(){return this._canvas.offsetWidth},getHeight:function(){return this._canvas.offsetHeight},getAspectRatio:function(){return this.getWidth()/this.getHeight()},resize:function(a,b){var c=this.getCanvas(),d=this.getContainer(),e=this.getWidth(),f=this.getHeight();c.width=a;c.height=b;TentaGL.Viewport.set(this.getGL(),[0,0,a,b]);d.style.width=a;d.style.height=b;var c=
...
TentaGL.SimpleShader.load=function(a,b){var c=new TentaGL.SimpleShader(a);TentaGL.ShaderLib.add(a,b,c);return c};Util.Inheritance.inherit(TentaGL.SimpleShader,TentaGL.ShaderProgram);TentaGL.Timer=function(a){this._startTime=a;this._accumulated=0;this._countdown=void 0;this._state=void 0!==a?TentaGL.Timer.RUNNING:TentaGL.Timer.STOPPED};TentaGL.Timer.STOPPED=1;TentaGL.Timer.RUNNING=2;TentaGL.Timer.PAUSED=3;
