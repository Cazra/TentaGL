...
a);return!0}return!1},_getPixelAt:function(a,b,c){return this._pixels.getPixelAt(a,b,c)},getSpriteAt:function(a,b){if(this._pixels){var c=this._getPixelAt(a,b),c=TentaGL.Color.rgba2Hex(c[0],c[1],c[2],c[3]);return this._sprites[c]}},getSpriteAtMouse:function(a){var b=a.getX();a=this._app.getHeight()-a.getY();return this.getSpriteAt(b,a)}};TentaGL.AppResizeListener=function(){};TentaGL.AppResizeListener.prototype={constructor:TentaGL.AppResizeListener,isaAppResizeListener:!0,handleAppResizeEvent:function(a){}};
...
c,f,g,h,255)}}this.setPixel(a,c,f,g,h,l)}};TentaGL.RGBAFilter.OutlineColor.RGBBytes=function(a,b,c){a=TentaGL.Color.RGBABytes(a,b,c);return new TentaGL.RGBAFilter.OutlineColor(a)};Util.Inheritance.inherit(TentaGL.RGBAFilter.OutlineColor,TentaGL.RGBAFilter);TentaGL.RGBAFilter.SubColor=function(a){this._color=a};
...
TentaGL.BlitteredFont.fromFont=function(a,b,c,d,e){var f="monospace"==a.getType(),g=a.getStringDimensions("W"),h=Math.floor(g[0]),g=Math.floor(g[1]);c=new TentaGL.BlitteredFont(void 0,f,h,g,c,d);d=1.5<b.getRed()+b.getGreen()+b.getBlue()?new TentaGL.Color.RGBA(0,0,0,1):new TentaGL.Color.RGBA(1,1,1,1);for(var l=TentaGL.Canvas2D.create(16*(h+2),6*(g+2),d),k=32;128>k;k++){var m=1+(k-32)%16*(h+2),p=1+Math.floor((k-32)/16)*(g+2),n=String.fromCharCode(k),r=TentaGL.Canvas2D.create(h,g,d);TentaGL.Canvas2D.drawString(r,
n,a,b,0,0);TentaGL.Canvas2D.drawImage(l,r,m,p)}a=TentaGL.PixelData.fromCanvas(l);a=a.filter(new TentaGL.RGBAFilter.OneColor(b,.5));e&&(a=e(a));c._createChars(a,f,h,g);return c};TentaGL.Font=function(a,b,c){this._name=a;this._type=b;this._size=c;this._italic=this._bold=!1;this._vPad=1};
...
b){this._breakPtsUni.set(a,b);this._breakPtCountUni.set(a,[b.length])}};Util.Inheritance.inherit(TentaGL.GradientShader,TentaGL.ShaderProgram);
...
TentaGL.Tooltip.getDefault=function(a){if(!a._defaultTooltip){var b=new TentaGL.Font("Arial","sans-serif",10),c=TentaGL.Color.RGBA(.8,.8,.8,1),b=TentaGL.BlitteredFont.fromFont(b,c,1,1,function(a){return a=a.filter(TentaGL.RGBAFilter.OutlineColor.RGBBytes(150,150,200))});a._defaultTooltip=new TentaGL.Tooltip(b,"_defaultTooltipBGColor",4,1E3)}return a._defaultTooltip};
