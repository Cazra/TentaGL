...
TentaGL.Math.Shape2D=function(){};TentaGL.Math.Shape2D.prototype={constructor:TentaGL.Math.Shape2D,isaShape2D:!0,containsPt:function(a){},getBounds2D:function(){},render:function(a,b){}};Util.Inheritance.inherit(TentaGL.Math.Shape2D,TentaGL.Renderable);TentaGL.Math.BezierCurve2D=function(a,b,c){this._startPt=vec2.copy([],a);this._controlPts=[];for(a=0;a<b.length;a++)this._controlPts[a]=vec2.copy([],b[a]);this._endPt=vec2.copy([],c)};
TentaGL.Math.BezierCurve2D.prototype={constructor:TentaGL.Math.BezierCurve2D,isaBezierCurve2D:!0,start:function(a){void 0!==a&&(this._startPt=a);return this._startPt},control:function(a,b){if(0>a||a>=this._controlPts.length)throw Error("Control point index out of bounds.");void 0!==b&&(this._controlPts[a]=b);return this._controlPts[a]},getDegree:function(){return this._controlPts.length},end:function(a){void 0!==a&&(this._endPt=a);return this._endPt},interpolate:function(a){var b=[];b.push(this._startPt);
b=b.concat(this._controlPts);b.push(this._endPt);return this._interpolate(a,b)},_interpolate:function(a,b){if(1==b.length)return b[0];for(var c=[],d=0;d<b.length-1;d++){var e=b[d+1],e=vec2.add([],vec2.scale([],b[d],1-a),vec2.scale([],e,a));c.push(e)}return this._interpolate(a,c)},containsPt:function(a){},getBounds2D:function(){},render:function(a,b){}};Util.Inheritance.inherit(TentaGL.Math.BezierCurve2D,TentaGL.Math.Shape2D);
